...
class SchemaDatabasesApi(ApiBase):
    ...
    def add_database(self, *, body: "Optional[GsaAddDatabase]" = None) -> "Union[GsaSlimDatabase, None]":
    ...
    def _add_database_with_http_info(self, body: "Optional[GsaAddDatabase]" = None, **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method add_database")
            params[key] = val
        del params["kwargs"]
    ...
    def _get_all_databases_with_http_info(self, role: "Optional[str]" = None, **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_all_databases")
            params[key] = val
        del params["kwargs"]
    ...
    def _get_database_with_http_info(self, database_key: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_database")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "database_key" is set
        if "database_key" not in params or params["database_key"] is None:
            raise ValueError("Missing the required parameter 'database_key' when calling 'get_database'")
    ...
    def _lock_database_with_http_info(self, database_key: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method lock_database")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "database_key" is set
        if "database_key" not in params or params["database_key"] is None:
            raise ValueError("Missing the required parameter 'database_key' when calling 'lock_database'")
    ...
    def _reload_database_with_http_info(self, database_key: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method reload_database")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "database_key" is set
        if "database_key" not in params or params["database_key"] is None:
            raise ValueError("Missing the required parameter 'database_key' when calling 'reload_database'")
        ...
        return self.api_client.call_api(
            "/v1alpha/databases/{database-key}:reload", "POST",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _remove_database_with_http_info(self, database_key: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method remove_database")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "database_key" is set
        if "database_key" not in params or params["database_key"] is None:
            raise ValueError("Missing the required parameter 'database_key' when calling 'remove_database'")
        ...
        return self.api_client.call_api(
            "/v1alpha/databases/{database-key}", "DELETE",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _unlock_database_with_http_info(self, database_key: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method unlock_database")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "database_key" is set
        if "database_key" not in params or params["database_key"] is None:
            raise ValueError("Missing the required parameter 'database_key' when calling 'unlock_database'")
    ...
    def update_database(self, *, database_key: "str", body: "Optional[GsaUpdateDatabase]" = None, allow_reload: "Optional[bool]" = False) -> "Union[GsaDatabase, None]":
        ...
        Union[GsaDatabase, None]
        """
        data = self._update_database_with_http_info(database_key, body, allow_reload, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _update_database_with_http_info(self, database_key: "str", body: "Optional[GsaUpdateDatabase]" = None, allow_reload: "Optional[bool]" = False, **kwargs: Any) -> Any:
        all_params = ["database_key", "body", "allow_reload", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method update_database")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "database_key" is set
        if "database_key" not in params or params["database_key"] is None:
            raise ValueError("Missing the required parameter 'database_key' when calling 'update_database'")
    ...
    def _upgrade_database_with_http_info(self, database_key: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method upgrade_database")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "database_key" is set
        if "database_key" not in params or params["database_key"] is None:
            raise ValueError("Missing the required parameter 'database_key' when calling 'upgrade_database'")
        ...
        return self.api_client.call_api(
            "/v1alpha/databases/{database-key}:upgrade", "POST",
            path_params,
            query_params,
            header_params,
            body=body_params,
