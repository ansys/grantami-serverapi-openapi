...
class HelpLocationApi(ApiBase):
    ...
    def _get_help_url_with_http_info(self, help_key: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_help_url")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "help_key" is set
        if "help_key" not in params or params["help_key"] is None:
            raise ValueError("Missing the required parameter 'help_key' when calling 'get_help_url'")
        ...
        return self.api_client.call_api(
            "/v1alpha/help-location/url/{help-key}", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _get_help_url_redirect_with_http_info(self, help_key: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_help_url_redirect")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "help_key" is set
        if "help_key" not in params or params["help_key"] is None:
            raise ValueError("Missing the required parameter 'help_key' when calling 'get_help_url_redirect'")
        ...
        return self.api_client.call_api(
            "/v1alpha/help-location/redirect/{help-key}", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
