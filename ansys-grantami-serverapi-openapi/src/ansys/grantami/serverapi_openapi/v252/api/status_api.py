...
class StatusApi(ApiBase):
    ...
    def _get_database_status_with_http_info(self, database_key: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_database_status")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "database_key" is set
        if "database_key" not in params or params["database_key"] is None:
            raise ValueError("Missing the required parameter 'database_key' when calling 'get_database_status'")
        ...
        return self.api_client.call_api(
            "/v1alpha/status/databases/{database-key}", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _get_search_cluster_status_with_http_info(self, **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_search_cluster_status")
            params[key] = val
        del params["kwargs"]
        ...
        return self.api_client.call_api(
            "/v1alpha/status/search-cluster", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
