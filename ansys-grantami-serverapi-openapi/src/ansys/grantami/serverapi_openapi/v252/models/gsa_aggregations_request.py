...
class GsaAggregationsRequest(ModelBase):
    ...
    def __init__(self, *, aggregation_criteria: "Union[list[GsaAggregationCriterion], None, Unset_Type]" = Unset, criterion: "Union[GsaCriterion, Unset_Type]" = Unset,) -> None:
    ...
    def aggregation_criteria(self, aggregation_criteria: "Union[list[GsaAggregationCriterion], None, Unset_Type]") -> None:
