...
class GsaReplacementStringsInfo(ModelBase):
    ...
    def __init__(self, *, replacement_strings: "list[GsaSlimReplacementString]",) -> None:
    ...
    def replacement_strings(self, replacement_strings: "list[GsaSlimReplacementString]") -> None:
        ...
        if replacement_strings is None:
            raise ValueError("Invalid value for 'replacement_strings', must not be 'None'")
        # Field is required
        if replacement_strings is Unset:  # type: ignore[comparison-overlap, unused-ignore]
            raise ValueError("Invalid value for 'replacement_strings', must not be 'Unset'")
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaReplacementStringsInfo):
            return False
