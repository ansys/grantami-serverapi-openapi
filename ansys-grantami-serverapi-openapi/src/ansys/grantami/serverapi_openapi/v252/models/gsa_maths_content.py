...
class GsaMathsContent(ModelBase):
    ...
    def __init__(self, *, parameter_contents: "list[GsaParameterContent]", transpose_axes: "bool", use_logarithmic_scale: "bool", curve_label: "Union[str, None, Unset_Type]" = Unset, expression: "Union[GsaSlimExpression, Unset_Type]" = Unset, free_parameter: "Union[GsaSlimNamedEntity, Unset_Type]" = Unset,) -> None:
