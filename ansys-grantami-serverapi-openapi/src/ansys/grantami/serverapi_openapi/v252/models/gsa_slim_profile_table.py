...
class GsaSlimProfileTable(ModelBase):
    ...
    def __init__(self, *, database_guid: "str", table_guid: "str", database_fallback_hint: "Union[str, None, Unset_Type]" = Unset, guid: "Union[str, None, Unset_Type]" = Unset, table_fallback_hint: "Union[str, None, Unset_Type]" = Unset,) -> None:
    ...
    def database_fallback_hint(self, database_fallback_hint: "Union[str, None, Unset_Type]") -> None:
