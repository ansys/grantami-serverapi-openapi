...
class GsaCreateAttributeLinkPair(ModelBase):
    ...
    def __init__(self, *, attribute_source_guid: "str", attribute_target_guid: "str",) -> None:
        """GsaCreateAttributeLinkPair - a model defined in Swagger
    ...
    def attribute_source_guid(self) -> "str":
        """Gets the attribute_source_guid of this GsaCreateAttributeLinkPair.

        Returns
        -------
        str
            The attribute_source_guid of this GsaCreateAttributeLinkPair.
        """
    ...
    def attribute_source_guid(self, attribute_source_guid: "str") -> None:
        """Sets the attribute_source_guid of this GsaCreateAttributeLinkPair.
    ...
    def attribute_target_guid(self) -> "str":
        """Gets the attribute_target_guid of this GsaCreateAttributeLinkPair.

        Returns
        -------
        str
            The attribute_target_guid of this GsaCreateAttributeLinkPair.
        """
    ...
    def attribute_target_guid(self, attribute_target_guid: "str") -> None:
        """Sets the attribute_target_guid of this GsaCreateAttributeLinkPair.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaCreateAttributeLinkPair):
            return False
