...
from ansys.grantami.serverapi_openapi.v252.models.gsa_record_link_group import GsaRecordLinkGroup  # noqa: F401
...
class GsaStaticRecordLinkGroup(GsaRecordLinkGroup):
    ...
    def __init__(self, *, display_names: "dict[str, str]", guid: "str", include_indirect_links: "bool", link_info: "GsaLinkInfo", name: "str", reverse_name: "str", type: "GsaRecordLinkGroupType" = GsaRecordLinkGroupType.STATIC, identity: "Union[int, None, Unset_Type]" = Unset, reverse_display_names: "Union[dict[str, str], None, Unset_Type]" = Unset,) -> None:
    ...
    def include_indirect_links(self) -> "bool":
        """Gets the include_indirect_links of this GsaStaticRecordLinkGroup.

        Returns
        -------
        bool
            The include_indirect_links of this GsaStaticRecordLinkGroup.
        """
    ...
    def include_indirect_links(self, include_indirect_links: "bool") -> None:
        """Sets the include_indirect_links of this GsaStaticRecordLinkGroup.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaStaticRecordLinkGroup):
            return False
