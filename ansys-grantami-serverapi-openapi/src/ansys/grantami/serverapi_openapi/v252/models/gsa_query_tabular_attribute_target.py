...
class GsaQueryTabularAttributeTarget(ModelBase):
    ...
    def __init__(self, *, target_attribute_guid: "Union[str, None, Unset_Type]" = Unset, target_database_guid: "Union[str, None, Unset_Type]" = Unset, target_database_version_guid: "Union[str, None, Unset_Type]" = Unset, target_table_guid: "Union[str, None, Unset_Type]" = Unset,) -> None:
        ...
        self._target_database_version_guid: Union[str, None, Unset_Type] = Unset
    ...
    @property
    def target_database_version_guid(self) -> "Union[str, None, Unset_Type]":
    ...
    def target_database_version_guid(self, target_database_version_guid: "Union[str, None, Unset_Type]") -> None:
        """Sets the target_database_version_guid of this GsaQueryTabularAttributeTarget.

        Parameters
        ----------
        target_database_version_guid: Union[str, None, Unset_Type]
            The target_database_version_guid of this GsaQueryTabularAttributeTarget.
        """
