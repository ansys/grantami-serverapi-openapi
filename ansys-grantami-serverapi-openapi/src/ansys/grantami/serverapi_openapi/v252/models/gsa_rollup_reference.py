...
class GsaRollupReference(ModelBase):
    ...
    def __init__(self, *, database_key: "str", rollup_type: "GsaTabularColumnRollUpType", attribute_guid: "Union[str, None, Unset_Type]" = Unset, attribute_identity: "Union[int, None, Unset_Type]" = Unset,) -> None:
