...
from ansys.grantami.serverapi_openapi.v252.models.gsa_layout_item import GsaLayoutItem  # noqa: F401
from ansys.grantami.serverapi_openapi.v252.models.gsa_layout_item_type import GsaLayoutItemType
...
class GsaLayoutAttributeItem(GsaLayoutItem):
    ...
    def __init__(self, *, attribute_type: "GsaAttributeType", guid: "str", item_type: "GsaLayoutItemType" = GsaLayoutItemType.ATTRIBUTE, name: "str", read_only: "bool", required: "bool", underlying_entity_guid: "str", meta_attributes: "Union[list[GsaLayoutAttributeItem], None, Unset_Type]" = Unset, tabular_columns: "Union[list[GsaLayoutTabularColumn], None, Unset_Type]" = Unset,) -> None:
        ...
        """
        super().__init__(guid=guid, item_type=item_type, name=name, underlying_entity_guid=underlying_entity_guid)
    ...
    def meta_attributes(self, meta_attributes: "Union[list[GsaLayoutAttributeItem], None, Unset_Type]") -> None:
    ...
    def tabular_columns(self, tabular_columns: "Union[list[GsaLayoutTabularColumn], None, Unset_Type]") -> None:
