...
class GsaQueryAttributeFilter(ModelBase):
    ...
    def __init__(self, *, guid: "Union[list[str], None, Unset_Type]" = Unset, name: "Union[list[str], None, Unset_Type]" = Unset, type: "Union[list[GsaAttributeType], None, Unset_Type]" = Unset,) -> None:
