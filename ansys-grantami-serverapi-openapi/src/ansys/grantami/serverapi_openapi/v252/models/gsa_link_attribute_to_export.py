...
from ansys.grantami.serverapi_openapi.v252.models.gsa_attribute_to_export import GsaAttributeToExport  # noqa: F401
...
class GsaLinkAttributeToExport(GsaAttributeToExport):
    ...
    def __init__(self, *, attribute_type: "str" = "link", attributes: "Union[list[GsaAttributeToExport], None, Unset_Type]" = Unset, export_in_reversed_direction: "Union[bool, Unset_Type]" = Unset, guid: "Union[str, None, Unset_Type]" = Unset, identity: "Union[int, None, Unset_Type]" = Unset, indirect_links_behavior: "Union[GsaIndirectLinks, Unset_Type]" = Unset, link_attribute_type: "Union[GsaLinkAttributeType, Unset_Type]" = Unset, linked_records_export_behavior: "Union[GsaLinkedRecordExportBehavior, Unset_Type]" = Unset, local_data: "Union[list[GsaSimpleAttributeToExport], None, Unset_Type]" = Unset, record_properties: "Union[list[GsaRecordProperty], None, Unset_Type]" = Unset, target_attribute_guid: "Union[str, None, Unset_Type]" = Unset, target_database_guid: "Union[str, None, Unset_Type]" = Unset, target_table_guid: "Union[str, None, Unset_Type]" = Unset,) -> None:
        ...
        self._linked_records_export_behavior: Union[GsaLinkedRecordExportBehavior, Unset_Type] = Unset
    ...
    @local_data.setter
    def local_data(self, local_data: "Union[list[GsaSimpleAttributeToExport], None, Unset_Type]") -> None:
    ...
    def link_attribute_type(self, link_attribute_type: "Union[GsaLinkAttributeType, Unset_Type]") -> None:
    ...
    def export_in_reversed_direction(self, export_in_reversed_direction: "Union[bool, Unset_Type]") -> None:
    ...
    def record_properties(self, record_properties: "Union[list[GsaRecordProperty], None, Unset_Type]") -> None:
    ...
    def linked_records_export_behavior(self, linked_records_export_behavior: "Union[GsaLinkedRecordExportBehavior, Unset_Type]") -> None:
        ...
        if linked_records_export_behavior is None:
            raise ValueError("Invalid value for 'linked_records_export_behavior', must not be 'None'")
    ...
    def indirect_links_behavior(self, indirect_links_behavior: "Union[GsaIndirectLinks, Unset_Type]") -> None:
