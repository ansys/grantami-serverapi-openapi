...
class GsaLocalColumnAggregationCriterion(ModelBase):
    ...
    def __init__(self, *, local_column_aggregation_criterion_type: "GsaLocalColumnAggregationType", guid: "Union[str, None, Unset_Type]" = Unset, identity: "Union[int, None, Unset_Type]" = Unset,) -> None:
    ...
    def local_column_aggregation_criterion_type(self, local_column_aggregation_criterion_type: "GsaLocalColumnAggregationType") -> None:
