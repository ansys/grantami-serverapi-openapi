...
class GsaPagingOptions(ModelBase):
    ...
    def __init__(self, *, keep_alive_in_minutes: "Union[int, None, Unset_Type]" = Unset, page_number: "Union[int, None, Unset_Type]" = Unset, page_size: "Union[int, Unset_Type]" = Unset,) -> None:
