...
class GsaQueryAttributeInfoProperties(ModelBase):
    ...
    def __init__(self, *, chartable: "Union[bool, None, Unset_Type]" = Unset, ordered_meta_attributes: "Union[GsaQuerySlimNamedEntityProperties, Unset_Type]" = Unset,) -> None:
    ...
    def ordered_meta_attributes(self, ordered_meta_attributes: "Union[GsaQuerySlimNamedEntityProperties, Unset_Type]") -> None:
