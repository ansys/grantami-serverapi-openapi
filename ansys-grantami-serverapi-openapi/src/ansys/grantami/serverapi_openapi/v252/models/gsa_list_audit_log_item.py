...
class GsaListAuditLogItem(ModelBase):
    ...
    def user_or_group_affected(self, user_or_group_affected: "Union[GsaListsUserOrGroup, Unset_Type]") -> None:
