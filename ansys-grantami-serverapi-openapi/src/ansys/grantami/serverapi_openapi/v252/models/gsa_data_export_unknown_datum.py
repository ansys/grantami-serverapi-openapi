...
class GsaDataExportUnknownDatum(GsaDataExportDatum):
    ...
    def __init__(self, *, attribute_guid: "str", attribute_identity: "int", datum_type: "GsaAttributeType", not_applicable: "str" = "unknown", meta_datums: "Union[list[GsaDataExportDatum], None, Unset_Type]" = Unset,) -> None:
