...
class GsaRecordListPermissionFlags(ModelBase):
    ...
    def __init__(self, *, is_administrator: "bool", is_curator: "bool", is_owner: "bool", is_publisher: "bool", is_subscribed: "bool",) -> None:
        """GsaRecordListPermissionFlags - a model defined in Swagger
    ...
    def is_owner(self) -> "bool":
        """Gets the is_owner of this GsaRecordListPermissionFlags.
        Flag indicating if the user or group is an owner of this list.

        Returns
        -------
        bool
            The is_owner of this GsaRecordListPermissionFlags.
        """
        return self._is_owner

    @is_owner.setter
    def is_owner(self, is_owner: "bool") -> None:
        """Sets the is_owner of this GsaRecordListPermissionFlags.
        Flag indicating if the user or group is an owner of this list.
    ...
    def is_subscribed(self) -> "bool":
        """Gets the is_subscribed of this GsaRecordListPermissionFlags.
        Flag indicating if the user or group is subscribed to this list.

        Returns
        -------
        bool
            The is_subscribed of this GsaRecordListPermissionFlags.
        """
        return self._is_subscribed

    @is_subscribed.setter
    def is_subscribed(self, is_subscribed: "bool") -> None:
        """Sets the is_subscribed of this GsaRecordListPermissionFlags.
        Flag indicating if the user or group is subscribed to this list.
    ...
    def is_curator(self) -> "bool":
        """Gets the is_curator of this GsaRecordListPermissionFlags.
        Flag indicating if the user or group is a curator of this list.

        Returns
        -------
        bool
            The is_curator of this GsaRecordListPermissionFlags.
        """
        return self._is_curator

    @is_curator.setter
    def is_curator(self, is_curator: "bool") -> None:
        """Sets the is_curator of this GsaRecordListPermissionFlags.
        Flag indicating if the user or group is a curator of this list.
    ...
    def is_administrator(self) -> "bool":
        """Gets the is_administrator of this GsaRecordListPermissionFlags.
        Flag indicating if the user or group is an administrator of this list.

        Returns
        -------
        bool
            The is_administrator of this GsaRecordListPermissionFlags.
        """
        return self._is_administrator

    @is_administrator.setter
    def is_administrator(self, is_administrator: "bool") -> None:
        """Sets the is_administrator of this GsaRecordListPermissionFlags.
        Flag indicating if the user or group is an administrator of this list.
    ...
    def is_publisher(self) -> "bool":
        """Gets the is_publisher of this GsaRecordListPermissionFlags.
        Flag indicating if this user or group is a publisher of this list.

        Returns
        -------
        bool
            The is_publisher of this GsaRecordListPermissionFlags.
        """
        return self._is_publisher

    @is_publisher.setter
    def is_publisher(self, is_publisher: "bool") -> None:
        """Sets the is_publisher of this GsaRecordListPermissionFlags.
        Flag indicating if this user or group is a publisher of this list.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaRecordListPermissionFlags):
            return False
