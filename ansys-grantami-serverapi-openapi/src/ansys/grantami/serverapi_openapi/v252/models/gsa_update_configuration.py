...
class GsaUpdateConfiguration(ModelBase):
    ...
    def __init__(self, *, description: "Union[str, None, Unset_Type]" = Unset, guid: "Union[str, Unset_Type]" = Unset, name: "Union[str, Unset_Type]" = Unset, value: "Union[str, Unset_Type]" = Unset,) -> None:
        """GsaUpdateConfiguration - a model defined in Swagger
    ...
    def name(self) -> "Union[str, Unset_Type]":
        """Gets the name of this GsaUpdateConfiguration.

        Returns
        -------
        Union[str, Unset_Type]
            The name of this GsaUpdateConfiguration.
        """
        return self._name

    @name.setter
    def name(self, name: "Union[str, Unset_Type]") -> None:
        """Sets the name of this GsaUpdateConfiguration.
    ...
    def guid(self) -> "Union[str, Unset_Type]":
        """Gets the guid of this GsaUpdateConfiguration.

        Returns
        -------
        Union[str, Unset_Type]
            The guid of this GsaUpdateConfiguration.
        """
        return self._guid

    @guid.setter
    def guid(self, guid: "Union[str, Unset_Type]") -> None:
        """Sets the guid of this GsaUpdateConfiguration.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaUpdateConfiguration):
            return False
