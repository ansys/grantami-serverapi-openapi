...
class GsaUpdateAllProfilesInfo(ModelBase):
    ...
    def __init__(self, *, default_profile: "Union[GsaUpdateDefaultProfile, Unset_Type]" = Unset, profiles: "Union[list[GsaSlimEntity], None, Unset_Type]" = Unset,) -> None:
    ...
    def default_profile(self, default_profile: "Union[GsaUpdateDefaultProfile, Unset_Type]") -> None:
