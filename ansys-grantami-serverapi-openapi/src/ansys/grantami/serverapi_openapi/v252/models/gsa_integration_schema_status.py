...
class GsaIntegrationSchemaStatus(ModelBase):
    ...
    def __init__(self, *, errored_databases: "Union[dict[str, str], None, Unset_Type]" = Unset, loaded_database_index_statuses: "Union[dict[str, GsaSearchIndexStatus], None, Unset_Type]" = Unset, loaded_databases: "Union[list[str], None, Unset_Type]" = Unset, loading_databases: "Union[list[str], None, Unset_Type]" = Unset, not_loaded_databases: "Union[list[str], None, Unset_Type]" = Unset, records_that_failed_to_index: "Union[list[GsaIndexRecordFailure], None, Unset_Type]" = Unset, search_index_in_sync: "Union[bool, Unset_Type]" = Unset, search_index_is_read_only: "Union[bool, None, Unset_Type]" = Unset, search_index_location: "Union[str, None, Unset_Type]" = Unset, search_index_out_of_date_duration: "Union[str, None, Unset_Type]" = Unset, search_index_unavailable: "Union[bool, None, Unset_Type]" = Unset, search_index_up_to_date: "Union[bool, Unset_Type]" = Unset,) -> None:
        ...
        self._loaded_database_index_statuses: Union[dict[str, GsaSearchIndexStatus], None, Unset_Type] = Unset
        ...
        self._records_that_failed_to_index: Union[list[GsaIndexRecordFailure], None, Unset_Type] = Unset
    ...
    def not_loaded_databases(self, not_loaded_databases: "Union[list[str], None, Unset_Type]") -> None:
    ...
    def errored_databases(self, errored_databases: "Union[dict[str, str], None, Unset_Type]") -> None:
    ...
    @property
    def loaded_database_index_statuses(self) -> "Union[dict[str, GsaSearchIndexStatus], None, Unset_Type]":
    ...
    def loaded_database_index_statuses(self, loaded_database_index_statuses: "Union[dict[str, GsaSearchIndexStatus], None, Unset_Type]") -> None:
    ...
    def search_index_out_of_date_duration(self, search_index_out_of_date_duration: "Union[str, None, Unset_Type]") -> None:
    ...
    def search_index_is_read_only(self, search_index_is_read_only: "Union[bool, None, Unset_Type]") -> None:
    ...
    def search_index_unavailable(self, search_index_unavailable: "Union[bool, None, Unset_Type]") -> None:
    ...
    @property
    def records_that_failed_to_index(self) -> "Union[list[GsaIndexRecordFailure], None, Unset_Type]":
    ...
    def records_that_failed_to_index(self, records_that_failed_to_index: "Union[list[GsaIndexRecordFailure], None, Unset_Type]") -> None:
