...
class GsaUnitEquivalentsInfo(ModelBase):
    ...
    def __init__(self, *, unit_equivalents: "Union[list[GsaUnitEquivalent], None, Unset_Type]" = Unset,) -> None:
    ...
    def unit_equivalents(self, unit_equivalents: "Union[list[GsaUnitEquivalent], None, Unset_Type]") -> None:
