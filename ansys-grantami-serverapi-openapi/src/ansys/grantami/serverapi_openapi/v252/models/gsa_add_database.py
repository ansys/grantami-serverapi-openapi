...
class GsaAddDatabase(ModelBase):
    ...
    def __init__(self, *, data_source: "str", database_key: "str", initial_catalog: "str", additional_sql_parameters: "Union[str, None, Unset_Type]" = Unset, is_read_only: "Union[bool, None, Unset_Type]" = Unset, language: "Union[str, None, Unset_Type]" = Unset, loading_order: "Union[int, None, Unset_Type]" = Unset, sql_password: "Union[str, None, Unset_Type]" = Unset, sql_user_name: "Union[str, None, Unset_Type]" = Unset, use_integrated_security: "Union[bool, None, Unset_Type]" = Unset, version_guid: "Union[str, None, Unset_Type]" = Unset,) -> None:
