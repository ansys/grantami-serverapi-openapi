...
class GsaAttributeReference(ModelBase):
    ...
    def __init__(self, *, database_key: "str", attribute_guid: "Union[str, None, Unset_Type]" = Unset, attribute_identity: "Union[int, None, Unset_Type]" = Unset,) -> None:
        """GsaAttributeReference - a model defined in Swagger
    ...
    def database_key(self) -> "str":
        """Gets the database_key of this GsaAttributeReference.

        Returns
        -------
        str
            The database_key of this GsaAttributeReference.
        """
        return self._database_key

    @database_key.setter
    def database_key(self, database_key: "str") -> None:
        """Sets the database_key of this GsaAttributeReference.
    ...
    def attribute_identity(self) -> "Union[int, None, Unset_Type]":
        """Gets the attribute_identity of this GsaAttributeReference.

        Returns
        -------
        Union[int, None, Unset_Type]
            The attribute_identity of this GsaAttributeReference.
        """
    ...
    def attribute_identity(self, attribute_identity: "Union[int, None, Unset_Type]") -> None:
        """Sets the attribute_identity of this GsaAttributeReference.
    ...
    def attribute_guid(self) -> "Union[str, None, Unset_Type]":
        """Gets the attribute_guid of this GsaAttributeReference.

        Returns
        -------
        Union[str, None, Unset_Type]
            The attribute_guid of this GsaAttributeReference.
        """
        return self._attribute_guid

    @attribute_guid.setter
    def attribute_guid(self, attribute_guid: "Union[str, None, Unset_Type]") -> None:
        """Sets the attribute_guid of this GsaAttributeReference.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaAttributeReference):
            return False
