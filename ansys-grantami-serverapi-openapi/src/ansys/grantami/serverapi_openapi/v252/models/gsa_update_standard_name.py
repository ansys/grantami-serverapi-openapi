...
class GsaUpdateStandardName(ModelBase):
    ...
    def __init__(self, *, guid: "Union[str, Unset_Type]" = Unset, mapped_attributes: "Union[list[GsaSlimEntity], None, Unset_Type]" = Unset, mapped_cross_database_record_link_groups: "Union[list[GsaSlimEntity], None, Unset_Type]" = Unset, mapped_parameters: "Union[list[GsaSlimEntity], None, Unset_Type]" = Unset, mapped_record_link_groups: "Union[list[GsaSlimEntity], None, Unset_Type]" = Unset, name: "Union[str, Unset_Type]" = Unset,) -> None:
        ...
        self._mapped_cross_database_record_link_groups: Union[list[GsaSlimEntity], None, Unset_Type] = Unset
    ...
    def mapped_attributes(self, mapped_attributes: "Union[list[GsaSlimEntity], None, Unset_Type]") -> None:
    ...
    def mapped_parameters(self, mapped_parameters: "Union[list[GsaSlimEntity], None, Unset_Type]") -> None:
    ...
    def mapped_record_link_groups(self, mapped_record_link_groups: "Union[list[GsaSlimEntity], None, Unset_Type]") -> None:
    ...
    @property
    def mapped_cross_database_record_link_groups(self) -> "Union[list[GsaSlimEntity], None, Unset_Type]":
    ...
    def mapped_cross_database_record_link_groups(self, mapped_cross_database_record_link_groups: "Union[list[GsaSlimEntity], None, Unset_Type]") -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaUpdateStandardName):
            return False
