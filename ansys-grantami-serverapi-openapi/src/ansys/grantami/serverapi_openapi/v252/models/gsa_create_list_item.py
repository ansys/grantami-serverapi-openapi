...
class GsaCreateListItem(ModelBase):
    ...
    def __init__(self, *, database_guid: "str", record_history_guid: "str", record_version: "Union[int, None, Unset_Type]" = Unset, table_guid: "Union[str, None, Unset_Type]" = Unset,) -> None:
