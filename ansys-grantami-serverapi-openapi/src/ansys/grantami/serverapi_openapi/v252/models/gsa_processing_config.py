...
class GsaProcessingConfig(ModelBase):
    ...
    def __init__(self, *, concurrency: "Union[int, Unset_Type]" = Unset, polling_interval_in_milliseconds: "Union[int, Unset_Type]" = Unset, purge_interval_in_milliseconds: "Union[int, Unset_Type]" = Unset, purge_job_age_in_milliseconds: "Union[int, Unset_Type]" = Unset,) -> None:
    ...
    def purge_job_age_in_milliseconds(self, purge_job_age_in_milliseconds: "Union[int, Unset_Type]") -> None:
        ...
        if purge_job_age_in_milliseconds is None:
            raise ValueError("Invalid value for 'purge_job_age_in_milliseconds', must not be 'None'")
    ...
    def purge_interval_in_milliseconds(self, purge_interval_in_milliseconds: "Union[int, Unset_Type]") -> None:
        ...
        if purge_interval_in_milliseconds is None:
            raise ValueError("Invalid value for 'purge_interval_in_milliseconds', must not be 'None'")
    ...
    def polling_interval_in_milliseconds(self, polling_interval_in_milliseconds: "Union[int, Unset_Type]") -> None:
        ...
        if polling_interval_in_milliseconds is None:
            raise ValueError("Invalid value for 'polling_interval_in_milliseconds', must not be 'None'")
