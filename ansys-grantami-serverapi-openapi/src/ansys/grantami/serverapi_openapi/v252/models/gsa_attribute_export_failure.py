...
class GsaAttributeExportFailure(GsaExportFailure):
    ...
    def __init__(self, *, failed_attributes: "list[GsaAttributeReference]", failure_details: "str", failure_reason: "str", type: "GsaExportFailureType" = GsaExportFailureType.ATTRIBUTE,) -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaAttributeExportFailure):
            return False
