...
class GsaAggregation(ModelBase):
    ...
    discriminator_value_class_map = {
        "attribute".lower(): "#/components/schemas/GsaAttributeAggregation",
        "text".lower(): "#/components/schemas/GsaFreeTextAggregation",
    }

    discriminator: Optional[str] = "type"

    def __init__(self, *, type: "GsaAggregationType",) -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaAggregation):
            return False
