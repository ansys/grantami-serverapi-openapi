...
class GsaSearchClusterStatus(ModelBase):
    ...
    def __init__(self, *, cluster_unavailable: "Union[bool, None, Unset_Type]" = Unset, disk_status: "Union[dict[str, GsaDiskStatus], None, Unset_Type]" = Unset, disk_threshold: "Union[str, None, Unset_Type]" = Unset, disk_threshold_max_headroom: "Union[str, None, Unset_Type]" = Unset,) -> None:
    ...
    def disk_threshold_max_headroom(self, disk_threshold_max_headroom: "Union[str, None, Unset_Type]") -> None:
