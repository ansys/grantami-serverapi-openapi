...
class GsaRecordWithData(ModelBase):
    ...
    def __init__(self, *, database_key: "str", record_version_guid: "str", data: "Union[list[GsaDataExportDatum], None, Unset_Type]" = Unset, properties: "Union[list[GsaProperty], None, Unset_Type]" = Unset, record_history_guid: "Union[str, None, Unset_Type]" = Unset, record_history_identity: "Union[int, Unset_Type]" = Unset,) -> None:
