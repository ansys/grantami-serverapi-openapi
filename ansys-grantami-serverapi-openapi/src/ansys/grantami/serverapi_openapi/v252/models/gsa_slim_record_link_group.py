...
class GsaSlimRecordLinkGroup(ModelBase):
    ...
    def __init__(self, *, display_names: "dict[str, str]", guid: "str", name: "str", reverse_name: "str", type: "GsaRecordLinkGroupType", identity: "Union[int, None, Unset_Type]" = Unset, reverse_display_names: "Union[dict[str, str], None, Unset_Type]" = Unset,) -> None:
        """GsaSlimRecordLinkGroup - a model defined in Swagger
    ...
    def identity(self) -> "Union[int, None, Unset_Type]":
        """Gets the identity of this GsaSlimRecordLinkGroup.

        Returns
        -------
        Union[int, None, Unset_Type]
            The identity of this GsaSlimRecordLinkGroup.
        """
        return self._identity

    @identity.setter
    def identity(self, identity: "Union[int, None, Unset_Type]") -> None:
        """Sets the identity of this GsaSlimRecordLinkGroup.
    ...
    def reverse_name(self) -> "str":
        """Gets the reverse_name of this GsaSlimRecordLinkGroup.

        Returns
        -------
        str
            The reverse_name of this GsaSlimRecordLinkGroup.
        """
        return self._reverse_name

    @reverse_name.setter
    def reverse_name(self, reverse_name: "str") -> None:
        """Sets the reverse_name of this GsaSlimRecordLinkGroup.
    ...
    def reverse_display_names(self) -> "Union[dict[str, str], None, Unset_Type]":
        """Gets the reverse_display_names of this GsaSlimRecordLinkGroup.

        Returns
        -------
        Union[dict[str, str], None, Unset_Type]
            The reverse_display_names of this GsaSlimRecordLinkGroup.
        """
        return self._reverse_display_names

    @reverse_display_names.setter
    def reverse_display_names(self, reverse_display_names: "Union[dict[str, str], None, Unset_Type]") -> None:
        """Sets the reverse_display_names of this GsaSlimRecordLinkGroup.
    ...
    def display_names(self) -> "dict[str, str]":
        ...
        -------
        dict[str, str]
            The display_names of this GsaSlimRecordLinkGroup.
        """
    ...
    @property
    def name(self) -> "str":
        """Gets the name of this GsaSlimRecordLinkGroup.

        Returns
        -------
        str
            The name of this GsaSlimRecordLinkGroup.
        """
        return self._name

    @name.setter
    def name(self, name: "str") -> None:
        """Sets the name of this GsaSlimRecordLinkGroup.
    ...
    @property
    def guid(self) -> "str":
        """Gets the guid of this GsaSlimRecordLinkGroup.

        Returns
        -------
        str
            The guid of this GsaSlimRecordLinkGroup.
        """
        return self._guid

    @guid.setter
    def guid(self, guid: "str") -> None:
        """Sets the guid of this GsaSlimRecordLinkGroup.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaSlimRecordLinkGroup):
            return False
