...
class GsaStandardName(ModelBase):
    ...
    def __init__(self, *, database_guid: "str", database_key: "str", database_version_guid: "str", guid: "str", mapped_attributes: "list[GsaSlimAttribute]", mapped_cross_database_record_link_groups: "list[GsaSlimNamedEntity]", mapped_parameters: "list[GsaSlimNamedEntity]", mapped_record_link_groups: "list[GsaSlimNamedEntity]", name: "str",) -> None:
    ...
    def mapped_record_link_groups(self, mapped_record_link_groups: "list[GsaSlimNamedEntity]") -> None:
    ...
    def mapped_cross_database_record_link_groups(self, mapped_cross_database_record_link_groups: "list[GsaSlimNamedEntity]") -> None:
        ...
        if mapped_cross_database_record_link_groups is None:
            raise ValueError("Invalid value for 'mapped_cross_database_record_link_groups', must not be 'None'")
        # Field is required
        if mapped_cross_database_record_link_groups is Unset:  # type: ignore[comparison-overlap, unused-ignore]
            raise ValueError("Invalid value for 'mapped_cross_database_record_link_groups', must not be 'Unset'")
