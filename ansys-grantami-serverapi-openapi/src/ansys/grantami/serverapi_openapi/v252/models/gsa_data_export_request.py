...
class GsaDataExportRequest(ModelBase):
    ...
    def __init__(self, *, attributes: "list[GsaAttributeToExport]", record_properties: "list[GsaRecordProperty]", record_history_guids: "Union[list[str], None, Unset_Type]" = Unset, record_history_identities: "Union[list[int], None, Unset_Type]" = Unset, record_version_guids: "Union[list[str], None, Unset_Type]" = Unset,) -> None:
    ...
    def record_history_identities(self, record_history_identities: "Union[list[int], None, Unset_Type]") -> None:
    ...
    def record_history_guids(self, record_history_guids: "Union[list[str], None, Unset_Type]") -> None:
    ...
    @property
    def record_version_guids(self) -> "Union[list[str], None, Unset_Type]":
    ...
    def record_version_guids(self, record_version_guids: "Union[list[str], None, Unset_Type]") -> None:
        """Sets the record_version_guids of this GsaDataExportRequest.
        Data can be exported for either record histories or record versions in each request, not both.

        Parameters
        ----------
        record_version_guids: Union[list[str], None, Unset_Type]
            The record_version_guids of this GsaDataExportRequest.
        """
