...
class GsaRecordPropertySortCriterion(GsaSortCriterion):
    ...
    def __init__(self, *, type: "GsaSortCriterionType" = GsaSortCriterionType.RECORDPROPERTY, _property: "Union[GsaSearchableRecordProperty, Unset_Type]" = Unset, sort_direction: "Union[GsaSortDirection, Unset_Type]" = Unset, sort_type: "Union[GsaSortType, Unset_Type]" = Unset,) -> None:
