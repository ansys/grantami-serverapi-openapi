...
class GsaUpdateDynamicRecordLinkGroup(GsaUpdateRecordLinkGroup):
    ...
    def __init__(self, *, type: "GsaRecordLinkGroupType" = GsaRecordLinkGroupType.DYNAMIC, attribute_pairs: "Union[list[GsaCreateAttributeLinkPair], Unset_Type]" = Unset, forbid_orphans: "Union[bool, Unset_Type]" = Unset, guid: "Union[str, Unset_Type]" = Unset, name: "Union[str, Unset_Type]" = Unset, referential_integrity_model: "Union[GsaReferentialIntegrityModel, Unset_Type]" = Unset, reverse_name: "Union[str, Unset_Type]" = Unset,) -> None:
    ...
    def attribute_pairs(self, attribute_pairs: "Union[list[GsaCreateAttributeLinkPair], Unset_Type]") -> None:
