...
class GsaCreateStaticRecordLinkGroup(GsaCreateRecordLinkGroup):
    ...
    def __init__(self, *, link_target: "GsaLinkTarget", name: "str", reverse_name: "str", type: "GsaRecordLinkGroupType" = GsaRecordLinkGroupType.STATIC, guid: "Union[str, Unset_Type]" = Unset, include_indirect_links: "Union[bool, Unset_Type]" = Unset,) -> None:
