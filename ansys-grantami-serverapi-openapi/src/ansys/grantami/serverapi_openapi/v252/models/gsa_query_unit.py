...
class GsaQueryUnit(ModelBase):
    ...
    def __init__(self, *, equation: "Union[str, None, Unset_Type]" = Unset, guid: "Union[str, None, Unset_Type]" = Unset, name: "Union[str, None, Unset_Type]" = Unset, relative_symbol: "Union[str, None, Unset_Type]" = Unset, symbol: "Union[str, None, Unset_Type]" = Unset,) -> None:
