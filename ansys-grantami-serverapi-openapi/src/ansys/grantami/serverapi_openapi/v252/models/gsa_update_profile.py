...
class GsaUpdateProfile(ModelBase):
    ...
    def __init__(self, *, description: "Union[str, None, Unset_Type]" = Unset, group_name: "Union[str, None, Unset_Type]" = Unset, guid: "Union[str, None, Unset_Type]" = Unset, homepage_url: "Union[str, None, Unset_Type]" = Unset, name: "Union[str, Unset_Type]" = Unset, profile_table_guids: "Union[list[str], None, Unset_Type]" = Unset,) -> None:
    ...
    def profile_table_guids(self, profile_table_guids: "Union[list[str], None, Unset_Type]") -> None:
