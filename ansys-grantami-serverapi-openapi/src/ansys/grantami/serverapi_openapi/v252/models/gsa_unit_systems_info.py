...
class GsaUnitSystemsInfo(ModelBase):
    ...
    def __init__(self, *, unit_systems: "Union[list[GsaSlimUnitSystem], None, Unset_Type]" = Unset,) -> None:
    ...
    @unit_systems.setter
    def unit_systems(self, unit_systems: "Union[list[GsaSlimUnitSystem], None, Unset_Type]") -> None:
