...
class GsaParameterDeletionException(ModelBase):
    ...
    def __init__(self, *, code: "Union[SystemNetHttpStatusCode, Unset_Type]" = Unset, errors: "Union[list[GsaDataModificationErrorDetail], None, Unset_Type]" = Unset, message: "Union[str, None, Unset_Type]" = Unset,) -> None:
        """GsaParameterDeletionException - a model defined in Swagger
    ...
    def message(self) -> "Union[str, None, Unset_Type]":
        """Gets the message of this GsaParameterDeletionException.

        Returns
        -------
        Union[str, None, Unset_Type]
            The message of this GsaParameterDeletionException.
        """
        return self._message

    @message.setter
    def message(self, message: "Union[str, None, Unset_Type]") -> None:
        """Sets the message of this GsaParameterDeletionException.
    ...
    def errors(self) -> "Union[list[GsaDataModificationErrorDetail], None, Unset_Type]":
        """Gets the errors of this GsaParameterDeletionException.

        Returns
        -------
        Union[list[GsaDataModificationErrorDetail], None, Unset_Type]
            The errors of this GsaParameterDeletionException.
        """
        return self._errors

    @errors.setter
    def errors(self, errors: "Union[list[GsaDataModificationErrorDetail], None, Unset_Type]") -> None:
        """Sets the errors of this GsaParameterDeletionException.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaParameterDeletionException):
            return False
