...
class GsaGuidOnlyAttribute(ModelBase):
    ...
    def __init__(self, *, guid: "str", name: "str", type: "GsaAttributeType", discrete_type_guid: "Union[str, None, Unset_Type]" = Unset, graph_type: "Union[str, None, Unset_Type]" = Unset, is_unitted: "Union[bool, None, Unset_Type]" = Unset, parameters: "Union[list[GsaGuidOnlyIntegrationParameterInfo], None, Unset_Type]" = Unset, target_database: "Union[GsaObjectIdentifier, Unset_Type]" = Unset, target_table: "Union[GsaObjectIdentifier, Unset_Type]" = Unset, unit_symbol: "Union[str, None, Unset_Type]" = Unset, x_axis_parameter: "Union[str, None, Unset_Type]" = Unset,) -> None:
    ...
    @parameters.setter
    def parameters(self, parameters: "Union[list[GsaGuidOnlyIntegrationParameterInfo], None, Unset_Type]") -> None:
