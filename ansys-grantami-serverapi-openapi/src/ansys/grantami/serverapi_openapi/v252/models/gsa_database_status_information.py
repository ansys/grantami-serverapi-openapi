...
class GsaDatabaseStatusInformation(ModelBase):
    ...
    def __init__(self, *, database_is_read_only: "Union[bool, Unset_Type]" = Unset, database_key: "Union[str, None, Unset_Type]" = Unset, is_locked: "Union[bool, Unset_Type]" = Unset, schema_version: "Union[str, None, Unset_Type]" = Unset, search_index_in_sync: "Union[bool, Unset_Type]" = Unset, state: "Union[GsaDatabaseStatus, Unset_Type]" = Unset,) -> None:
