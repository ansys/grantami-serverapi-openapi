...
class GsaSearchResult(ModelBase):
    ...
    def __init__(self, *, database_key: "str", cubic_spline_status: "Union[str, None, Unset_Type]" = Unset, parent_guid: "Union[str, None, Unset_Type]" = Unset, record_color: "Union[str, None, Unset_Type]" = Unset, record_guid: "Union[str, Unset_Type]" = Unset, record_history_guid: "Union[str, Unset_Type]" = Unset, record_history_identity: "Union[int, Unset_Type]" = Unset, record_identity: "Union[int, Unset_Type]" = Unset, record_name: "Union[str, None, Unset_Type]" = Unset, score: "Union[float, None, Unset_Type]" = Unset, sorting_value: "Union[GsaSortingValue, Unset_Type]" = Unset, table_guid: "Union[str, Unset_Type]" = Unset, table_identity: "Union[int, Unset_Type]" = Unset, tree_name: "Union[str, None, Unset_Type]" = Unset, type: "Union[GsaRecordType, Unset_Type]" = Unset, version_control_state: "Union[str, None, Unset_Type]" = Unset, version_number: "Union[int, Unset_Type]" = Unset,) -> None:
