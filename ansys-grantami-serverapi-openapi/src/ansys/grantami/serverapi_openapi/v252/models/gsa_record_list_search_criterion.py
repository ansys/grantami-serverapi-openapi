...
class GsaRecordListSearchCriterion(GsaListCriterion):
    ...
    def __init__(self, *, type: "str" = "recordList", contains_records: "Union[list[GsaListItemRecordReference], None, Unset_Type]" = Unset, contains_records_in_databases: "Union[list[str], None, Unset_Type]" = Unset, contains_records_in_integration_schemas: "Union[list[str], None, Unset_Type]" = Unset, contains_records_in_tables: "Union[list[str], None, Unset_Type]" = Unset, is_awaiting_approval: "Union[bool, None, Unset_Type]" = Unset, is_internal_use: "Union[bool, None, Unset_Type]" = Unset, is_published: "Union[bool, None, Unset_Type]" = Unset, is_revision: "Union[bool, None, Unset_Type]" = Unset, name_contains: "Union[str, None, Unset_Type]" = Unset, user_can_add_or_remove_items: "Union[bool, None, Unset_Type]" = Unset, user_role: "Union[GsaUserRole, Unset_Type]" = Unset,) -> None:
    ...
    def contains_records_in_databases(self, contains_records_in_databases: "Union[list[str], None, Unset_Type]") -> None:
    ...
    def contains_records_in_integration_schemas(self, contains_records_in_integration_schemas: "Union[list[str], None, Unset_Type]") -> None:
    ...
    def contains_records_in_tables(self, contains_records_in_tables: "Union[list[str], None, Unset_Type]") -> None:
    ...
    def contains_records(self, contains_records: "Union[list[GsaListItemRecordReference], None, Unset_Type]") -> None:
    ...
    def user_can_add_or_remove_items(self, user_can_add_or_remove_items: "Union[bool, None, Unset_Type]") -> None:
