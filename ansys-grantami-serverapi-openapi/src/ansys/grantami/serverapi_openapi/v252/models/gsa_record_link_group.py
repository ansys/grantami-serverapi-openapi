...
class GsaRecordLinkGroup(ModelBase):
    ...
    def __init__(self, *, display_names: "dict[str, str]", guid: "str", link_info: "GsaLinkInfo", name: "str", reverse_name: "str", type: "GsaRecordLinkGroupType", identity: "Union[int, None, Unset_Type]" = Unset, reverse_display_names: "Union[dict[str, str], None, Unset_Type]" = Unset,) -> None:
