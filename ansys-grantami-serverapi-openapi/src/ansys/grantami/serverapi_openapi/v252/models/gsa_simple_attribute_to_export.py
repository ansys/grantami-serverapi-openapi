...
class GsaSimpleAttributeToExport(GsaAttributeToExport):
    ...
    def __init__(self, *, attribute_type: "str" = "simple", guid: "Union[str, None, Unset_Type]" = Unset, identity: "Union[int, None, Unset_Type]" = Unset, roll_up_type: "Union[GsaTabularColumnRollUpType, Unset_Type]" = Unset, summary_roll_up_type: "Union[GsaTabularColumnRollUpType, Unset_Type]" = Unset,) -> None:
    ...
    def summary_roll_up_type(self, summary_roll_up_type: "Union[GsaTabularColumnRollUpType, Unset_Type]") -> None:
