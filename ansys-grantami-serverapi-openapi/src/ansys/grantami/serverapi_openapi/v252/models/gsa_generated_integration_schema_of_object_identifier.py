...
class GsaGeneratedIntegrationSchemaOfObjectIdentifier(ModelBase):
    ...
    def __init__(self, *, schema: "GsaGuidOnlyIntegrationSchemaOfObjectIdentifier", warnings: "Union[list[GsaIntegrationSchemaGenerationErrorDetail], None, Unset_Type]" = Unset,) -> None:
        ...
        """
        self._warnings: Union[list[GsaIntegrationSchemaGenerationErrorDetail], None, Unset_Type] = Unset
    ...
    @property
    def warnings(self) -> "Union[list[GsaIntegrationSchemaGenerationErrorDetail], None, Unset_Type]":
    ...
    @warnings.setter
    def warnings(self, warnings: "Union[list[GsaIntegrationSchemaGenerationErrorDetail], None, Unset_Type]") -> None:
