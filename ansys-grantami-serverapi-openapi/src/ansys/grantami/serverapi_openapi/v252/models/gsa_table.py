...
class GsaTable(ModelBase):
    ...
    def __init__(self, *, display_names: "dict[str, str]", guid: "str", is_hidden_from_browse: "bool", is_hidden_from_search: "bool", is_versioned: "bool", layouts: "list[GsaSlimLayout]", name: "str", subsets: "list[GsaSlimSubset]", table_types: "list[str]", version_state: "GsaVersionState", default_layout: "Union[GsaSlimLayout, Unset_Type]" = Unset, default_subset: "Union[GsaSlimSubset, Unset_Type]" = Unset,) -> None:
