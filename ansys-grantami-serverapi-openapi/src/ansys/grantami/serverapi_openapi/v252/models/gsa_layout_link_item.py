...
class GsaLayoutLinkItem(GsaLayoutItem):
    ...
    def __init__(self, *, forwards: "bool", guid: "str", item_type: "GsaLayoutItemType" = GsaLayoutItemType.LINK, link_type: "GsaLayoutItemLinkType", name: "str", target_table: "str", underlying_entity_guid: "str", next_link: "Union[GsaLayoutLinkItem, Unset_Type]" = Unset, target_database: "Union[str, None, Unset_Type]" = Unset, target_database_version: "Union[str, None, Unset_Type]" = Unset,) -> None:
    ...
    def target_database_version(self, target_database_version: "Union[str, None, Unset_Type]") -> None:
