...
class GsaCreateContinuousRange(ModelBase):
    ...
    def __init__(self, *, high_value: "float", low_value: "float",) -> None:
        """GsaCreateContinuousRange - a model defined in Swagger
    ...
    def low_value(self) -> "float":
        """Gets the low_value of this GsaCreateContinuousRange.

        Returns
        -------
        float
            The low_value of this GsaCreateContinuousRange.
        """
        return self._low_value

    @low_value.setter
    def low_value(self, low_value: "float") -> None:
        """Sets the low_value of this GsaCreateContinuousRange.
    ...
    def high_value(self) -> "float":
        """Gets the high_value of this GsaCreateContinuousRange.

        Returns
        -------
        float
            The high_value of this GsaCreateContinuousRange.
        """
        return self._high_value

    @high_value.setter
    def high_value(self, high_value: "float") -> None:
        """Sets the high_value of this GsaCreateContinuousRange.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaCreateContinuousRange):
            return False
