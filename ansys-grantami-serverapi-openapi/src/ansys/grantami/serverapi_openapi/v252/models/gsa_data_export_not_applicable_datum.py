...
from ansys.grantami.serverapi_openapi.v252.models.gsa_data_export_datum import GsaDataExportDatum  # noqa: F401
...
class GsaDataExportNotApplicableDatum(GsaDataExportDatum):
    ...
    def __init__(self, *, attribute_guid: "str", attribute_identity: "int", datum_type: "GsaAttributeType", not_applicable: "str" = "notApplicable", meta_datums: "Union[list[GsaDataExportDatum], None, Unset_Type]" = Unset,) -> None:
