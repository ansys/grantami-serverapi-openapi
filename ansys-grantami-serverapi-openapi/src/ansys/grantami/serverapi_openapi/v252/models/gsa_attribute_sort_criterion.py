...
from ansys.grantami.serverapi_openapi.v252.models.gsa_sort_criterion import GsaSortCriterion  # noqa: F401
from ansys.grantami.serverapi_openapi.v252.models.gsa_sort_criterion_type import GsaSortCriterionType
...
class GsaAttributeSortCriterion(GsaSortCriterion):
    ...
    def __init__(self, *, type: "GsaSortCriterionType" = GsaSortCriterionType.ATTRIBUTE, attribute_type: "Union[GsaAttributeType, Unset_Type]" = Unset, guid: "Union[str, None, Unset_Type]" = Unset, identity: "Union[int, None, Unset_Type]" = Unset, sort_direction: "Union[GsaSortDirection, Unset_Type]" = Unset, sort_type: "Union[GsaSortType, Unset_Type]" = Unset,) -> None:
