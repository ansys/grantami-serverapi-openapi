...
class GsaRecordLinkGroupsInfo(ModelBase):
    ...
    def __init__(self, *, record_link_groups: "Union[list[GsaSlimRecordLinkGroup], None, Unset_Type]" = Unset,) -> None:
    ...
    def record_link_groups(self, record_link_groups: "Union[list[GsaSlimRecordLinkGroup], None, Unset_Type]") -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaRecordLinkGroupsInfo):
            return False
