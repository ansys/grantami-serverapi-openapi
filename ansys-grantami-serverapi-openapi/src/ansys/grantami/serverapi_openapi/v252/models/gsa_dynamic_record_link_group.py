...
class GsaDynamicRecordLinkGroup(GsaRecordLinkGroup):
    ...
    def __init__(self, *, attribute_pairs: "list[GsaAttributeLinkPair]", display_names: "dict[str, str]", forbid_orphans: "bool", guid: "str", link_info: "GsaLinkInfo", name: "str", referential_integrity_model: "GsaReferentialIntegrityModel", reverse_name: "str", type: "GsaRecordLinkGroupType" = GsaRecordLinkGroupType.DYNAMIC, identity: "Union[int, None, Unset_Type]" = Unset, reverse_display_names: "Union[dict[str, str], None, Unset_Type]" = Unset,) -> None:
    ...
    def referential_integrity_model(self, referential_integrity_model: "GsaReferentialIntegrityModel") -> None:
