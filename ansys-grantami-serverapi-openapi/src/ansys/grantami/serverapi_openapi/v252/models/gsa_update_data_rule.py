...
class GsaUpdateDataRule(ModelBase):
    ...
    def __init__(self, *, description: "Union[str, Unset_Type]" = Unset, guid: "Union[str, Unset_Type]" = Unset, name: "Union[str, Unset_Type]" = Unset, regular_expression: "Union[str, Unset_Type]" = Unset,) -> None:
