...
class GsaCreateRecordHistory(ModelBase):
    ...
    def __init__(self, *, name: "str", record_type: "GsaRecordType", guid: "Union[str, Unset_Type]" = Unset, parent: "Union[GsaSlimRecordHistory, Unset_Type]" = Unset, record_color: "Union[GsaRecordColor, Unset_Type]" = Unset, short_name: "Union[str, None, Unset_Type]" = Unset,) -> None:
