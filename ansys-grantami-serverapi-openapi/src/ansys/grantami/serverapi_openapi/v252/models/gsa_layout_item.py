...
class GsaLayoutItem(ModelBase):
    ...
    discriminator_value_class_map = {
        "attribute".lower(): "#/components/schemas/GsaLayoutAttributeItem",
        "link".lower(): "#/components/schemas/GsaLayoutLinkItem",
    }

    discriminator: Optional[str] = "itemType"

    def __init__(self, *, guid: "str", item_type: "GsaLayoutItemType", name: "str", underlying_entity_guid: "str",) -> None:
        """GsaLayoutItem - a model defined in Swagger
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaLayoutItem):
            return False
