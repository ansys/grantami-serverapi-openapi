...
class GsaFullLayoutSection(GsaLayoutSection):
    ...
    def __init__(self, *, display_names: "dict[str, str]", guid: "str", name: "str", section_detail_type: "GsaLayoutSectionDetailType" = GsaLayoutSectionDetailType.FULL, section_items: "list[GsaLayoutItem]",) -> None:
