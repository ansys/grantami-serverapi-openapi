...
class GsaRecordListSearchResult(ModelBase):
    ...
    def __init__(self, *, header: "GsaRecordListHeader", items: "list[GsaListItem]",) -> None:
    ...
    @property
    def header(self) -> "GsaRecordListHeader":
        """Gets the header of this GsaRecordListSearchResult.

        Returns
        -------
        GsaRecordListHeader
            The header of this GsaRecordListSearchResult.
        """
        return self._header

    @header.setter
    def header(self, header: "GsaRecordListHeader") -> None:
        """Sets the header of this GsaRecordListSearchResult.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaRecordListSearchResult):
            return False
