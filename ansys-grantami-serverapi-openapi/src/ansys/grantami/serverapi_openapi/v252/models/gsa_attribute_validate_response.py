...
class GsaAttributeValidateResponse(ModelBase):
    ...
    def __init__(self, *, has_validation_rules: "Union[bool, Unset_Type]" = Unset, is_valid: "Union[bool, Unset_Type]" = Unset, value_changed: "Union[bool, None, Unset_Type]" = Unset,) -> None:
