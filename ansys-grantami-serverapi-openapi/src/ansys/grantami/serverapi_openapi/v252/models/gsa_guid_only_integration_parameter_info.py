...
class GsaGuidOnlyIntegrationParameterInfo(ModelBase):
    ...
    def __init__(self, *, guid: "str", default_value: "Union[GsaDataExportParameterValue, Unset_Type]" = Unset, interpolation_type: "Union[GsaParameterInfoInterpolationType, Unset_Type]" = Unset, name: "Union[str, None, Unset_Type]" = Unset, parameter_type: "Union[GsaParameterInfoParameterType, Unset_Type]" = Unset, scale_type: "Union[GsaParameterInfoScaleType, Unset_Type]" = Unset, unit_symbol: "Union[str, None, Unset_Type]" = Unset,) -> None:
