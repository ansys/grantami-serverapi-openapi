...
class GsaDataExportDiscreteSeries(ModelBase):
    ...
    def __init__(self, *, parameter_values: "Union[list[GsaDataExportParameterValue], None, Unset_Type]" = Unset, points: "Union[list[GsaDataExportDiscreteSeriesPoint], None, Unset_Type]" = Unset,) -> None:
    ...
    @points.setter
    def points(self, points: "Union[list[GsaDataExportDiscreteSeriesPoint], None, Unset_Type]") -> None:
