...
class GsaSearchDetail(ModelBase):
    ...
    def __init__(self, *, criteria: "Union[str, None, Unset_Type]" = Unset, description: "Union[str, None, Unset_Type]" = Unset, name: "Union[str, None, Unset_Type]" = Unset, notes: "Union[str, None, Unset_Type]" = Unset,) -> None:
