...
class GsaQueryDiscreteTypesRequest(ModelBase):
    ...
    def __init__(self, *, properties: "GsaQueryDiscreteTypeProperties", filter: "Union[GsaQueryDiscreteTypeFilter, Unset_Type]" = Unset,) -> None:
    ...
    def properties(self) -> "GsaQueryDiscreteTypeProperties":
        """Gets the properties of this GsaQueryDiscreteTypesRequest.

        Returns
        -------
        GsaQueryDiscreteTypeProperties
            The properties of this GsaQueryDiscreteTypesRequest.
        """
        return self._properties

    @properties.setter
    def properties(self, properties: "GsaQueryDiscreteTypeProperties") -> None:
        """Sets the properties of this GsaQueryDiscreteTypesRequest.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaQueryDiscreteTypesRequest):
            return False
