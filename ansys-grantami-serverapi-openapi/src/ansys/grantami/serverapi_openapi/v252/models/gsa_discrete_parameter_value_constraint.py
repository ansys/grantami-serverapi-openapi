...
from ansys.grantami.serverapi_openapi.v252.models.gsa_parameter_constraint import GsaParameterConstraint  # noqa: F401
from ansys.grantami.serverapi_openapi.v252.models.gsa_parameter_constraint_type import GsaParameterConstraintType
...
class GsaDiscreteParameterValueConstraint(GsaParameterConstraint):
    ...
    def __init__(self, *, parameter: "GsaObjectIdentifier", type: "GsaParameterConstraintType" = GsaParameterConstraintType.DISCRETEVALUE, _none: "Union[list[float], None, Unset_Type]" = Unset, any: "Union[list[float], None, Unset_Type]" = Unset,) -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaDiscreteParameterValueConstraint):
            return False
