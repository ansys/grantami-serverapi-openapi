...
class GrantaServerApiListsDtoCreateRecordList(ModelBase):  # type: ignore[misc]
    ...
    def __init__(
        ...
        *,
        ...
        items: "Optional[GrantaServerApiListsDtoCreateRecordListItemsInfo]" = None,
    ...
    @property
    def items(self) -> "Optional[GrantaServerApiListsDtoCreateRecordListItemsInfo]":
    ...
    @items.setter
    def items(
        self, items: "Optional[GrantaServerApiListsDtoCreateRecordListItemsInfo]"
    ) -> None:
