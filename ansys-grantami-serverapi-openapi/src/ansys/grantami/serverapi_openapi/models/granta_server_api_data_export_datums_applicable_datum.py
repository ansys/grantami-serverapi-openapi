...
class GrantaServerApiDataExportDatumsApplicableDatum(ModelBase):
    ...
    discriminator_value_class_map = {
        ...
        'floatFunctional'.lower(): '#/components/schemas/GrantaServerApiDataExportDatumsFunctionalDatum',
        'hyperlink'.lower(): '#/components/schemas/GrantaServerApiDataExportDatumsHyperlinkDatum',
        'link'.lower(): '#/components/schemas/GrantaServerApiDataExportDatumsLinkedRecordsDatum',
