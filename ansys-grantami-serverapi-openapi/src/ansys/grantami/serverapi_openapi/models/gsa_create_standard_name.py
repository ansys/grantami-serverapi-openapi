...
class GsaCreateStandardName(ModelBase):
    ...
    def __init__(self, *, name: "str", guid: "Union[str, Unset_Type]" = Unset, mapped_attributes: "Union[list[GsaSlimEntity], None, Unset_Type]" = Unset, mapped_cross_database_record_link_groups: "Union[list[GsaSlimEntity], None, Unset_Type]" = Unset, mapped_parameters: "Union[list[GsaSlimEntity], None, Unset_Type]" = Unset, mapped_record_link_groups: "Union[list[GsaSlimEntity], None, Unset_Type]" = Unset,) -> None:
