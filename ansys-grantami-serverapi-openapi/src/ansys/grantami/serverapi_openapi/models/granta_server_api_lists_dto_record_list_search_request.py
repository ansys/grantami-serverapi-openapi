...
class GrantaServerApiListsDtoRecordListSearchRequest(ModelBase):
    ...
    def paging_options(self, paging_options: "GrantaServerApiListsDtoPagingOptions") -> None:
    ...
    def response_options(self, response_options: "GrantaServerApiListsDtoResponseOptions") -> None:
