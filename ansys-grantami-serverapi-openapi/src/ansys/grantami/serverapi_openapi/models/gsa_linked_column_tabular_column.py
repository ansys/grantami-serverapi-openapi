...
class GsaLinkedColumnTabularColumn(GsaTabularColumn):
    ...
    def __init__(self, *, column_type: "GsaTabularColumnDtoType" = GsaTabularColumnDtoType.LINKEDCOLUMN, display_names: "dict[str, str]", guid: "str", linked_attribute: "GsaSlimAttribute", linked_column: "GsaSlimNamedEntity", name: "str", roll_up_type: "GsaTabularColumnRollUpType", show_as_link: "bool", summary_row_enabled: "bool", summary_row_roll_up_type: "GsaTabularColumnRollUpType", summary_row_text: "str",) -> None:
