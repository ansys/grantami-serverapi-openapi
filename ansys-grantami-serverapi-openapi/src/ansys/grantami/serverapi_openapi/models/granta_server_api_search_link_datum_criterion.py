...
class GrantaServerApiSearchLinkDatumCriterion(GrantaServerApiSearchDatumCriterion):
    ...
    def local_criterion(self, local_criterion: "GrantaServerApiSearchCriterion") -> None:
    ...
    def inner_criterion(self, inner_criterion: "GrantaServerApiSearchCriterion") -> None:
