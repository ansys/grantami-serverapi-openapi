...
class GsaQueryAttribute(ModelBase):
    ...
    def __init__(self, *, about_attribute: "Union[GsaQuerySlimTypedAttribute, Unset_Type]" = Unset, attribute_parameters: "Union[list[GsaQuerySlimNamedEntity], None, Unset_Type]" = Unset, axis_name: "Union[GsaQueryAxisName, Unset_Type]" = Unset, data_rule: "Union[GsaQueryDataRule, Unset_Type]" = Unset, default_threshold_type: "Union[GsaAttributeThresholdType, Unset_Type]" = Unset, discrete_type: "Union[GsaQuerySlimDiscreteType, Unset_Type]" = Unset, display_names: "Union[dict[str, str], None, Unset_Type]" = Unset, expressions: "Union[list[GsaQuerySlimNamedEntity], None, Unset_Type]" = Unset, guid: "Union[str, None, Unset_Type]" = Unset, info: "Union[GsaQueryAttributeInfo, Unset_Type]" = Unset, is_functional_range: "Union[bool, None, Unset_Type]" = Unset, is_hidden_from_search_criteria: "Union[bool, None, Unset_Type]" = Unset, is_multi_valued: "Union[bool, None, Unset_Type]" = Unset, name: "Union[str, None, Unset_Type]" = Unset, tabular_columns: "Union[list[GsaQuerySlimNamedEntity], None, Unset_Type]" = Unset, target: "Union[GsaQueryTabularAttributeTarget, Unset_Type]" = Unset, type: "Union[GsaAttributeType, Unset_Type]" = Unset, unit: "Union[GsaQueryUnit, Unset_Type]" = Unset,) -> None:
    ...
    def about_attribute(self, about_attribute: "Union[GsaQuerySlimTypedAttribute, Unset_Type]") -> None:
    ...
    def tabular_columns(self, tabular_columns: "Union[list[GsaQuerySlimNamedEntity], None, Unset_Type]") -> None:
    ...
    def attribute_parameters(self, attribute_parameters: "Union[list[GsaQuerySlimNamedEntity], None, Unset_Type]") -> None:
    ...
    @expressions.setter
    def expressions(self, expressions: "Union[list[GsaQuerySlimNamedEntity], None, Unset_Type]") -> None:
