...
class GsaConstantsInfo(ModelBase):
    ...
    def __init__(self, *, constants: "Union[list[GsaSlimConstant], None, Unset_Type]" = Unset,) -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaConstantsInfo):
            return False
