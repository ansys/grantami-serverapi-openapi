...
class GsaQueryDiscreteTypeProperties(ModelBase):
    ...
    def __init__(self, *, discrete_values: "Union[GsaQuerySlimNamedEntityProperties, Unset_Type]" = Unset, guid: "Union[bool, None, Unset_Type]" = Unset, is_ordered: "Union[bool, None, Unset_Type]" = Unset, name: "Union[bool, None, Unset_Type]" = Unset,) -> None:
    ...
    def discrete_values(self, discrete_values: "Union[GsaQuerySlimNamedEntityProperties, Unset_Type]") -> None:
