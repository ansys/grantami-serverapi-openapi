...
class GsaDataExportTabularRow(ModelBase):
    ...
    def __init__(self, *, linked_data: "Union[list[GsaRecordWithData], None, Unset_Type]" = Unset, linked_records: "Union[list[GsaRecordHistoryReference], None, Unset_Type]" = Unset, linking_value: "Union[str, None, Unset_Type]" = Unset, local_data: "Union[list[GsaDataExportDatum], None, Unset_Type]" = Unset, rolled_up_data: "Union[list[GsaDataExportRollupDatum], None, Unset_Type]" = Unset, row_guid: "Union[str, Unset_Type]" = Unset, row_number: "Union[int, Unset_Type]" = Unset,) -> None:
    ...
    def linked_records(self, linked_records: "Union[list[GsaRecordHistoryReference], None, Unset_Type]") -> None:
