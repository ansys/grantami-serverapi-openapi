...
class GrantaServerApiDataExportDatumsRange(ModelBase):  # type: ignore[misc]
    ...
    @property
    def high_value_is_inclusive(self) -> "Optional[bool]":
    ...
    def high_value_is_inclusive(
        self, high_value_is_inclusive: "Optional[bool]"
    ) -> None:
    ...
    @property
    def low_value_is_inclusive(self) -> "Optional[bool]":
    ...
    def low_value_is_inclusive(self, low_value_is_inclusive: "Optional[bool]") -> None:
