...
class GsaCreateFolder(ModelBase):
    ...
    def __init__(self, *, name: "str", parent_guid: "str", guid: "Union[str, Unset_Type]" = Unset,) -> None:
        """GsaCreateFolder - a model defined in Swagger
    ...
    @property
    def name(self) -> "str":
        """Gets the name of this GsaCreateFolder.

        Returns
        -------
        str
            The name of this GsaCreateFolder.
        """
        return self._name

    @name.setter
    def name(self, name: "str") -> None:
        """Sets the name of this GsaCreateFolder.
    ...
    def guid(self) -> "Union[str, Unset_Type]":
        """Gets the guid of this GsaCreateFolder.

        Returns
        -------
        Union[str, Unset_Type]
            The guid of this GsaCreateFolder.
        """
        return self._guid

    @guid.setter
    def guid(self, guid: "Union[str, Unset_Type]") -> None:
        """Sets the guid of this GsaCreateFolder.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaCreateFolder):
            return False
