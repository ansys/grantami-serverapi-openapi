...
class GsaAttributeInfo(ModelBase):
    ...
    def __init__(self, *, chartable: "bool", expressionable: "bool", extended_name: "str", foreign_data_link_groups: "list[GsaSlimNamedEntity]", is_meta_attribute: "bool", linkable: "bool", primary_data_link_groups: "list[GsaSlimNamedEntity]", standard_names: "list[GsaSlimNamedEntity]", type_code: "str", foreign_dynamic_link_groups: "Union[list[GsaSlimNamedEntity], None, Unset_Type]" = Unset, ordered_meta_attributes: "Union[list[GsaSlimTypedAttribute], None, Unset_Type]" = Unset, primary_dynamic_link_groups: "Union[list[GsaSlimNamedEntity], None, Unset_Type]" = Unset,) -> None:
    ...
    def ordered_meta_attributes(self, ordered_meta_attributes: "Union[list[GsaSlimTypedAttribute], None, Unset_Type]") -> None:
    ...
    def primary_data_link_groups(self, primary_data_link_groups: "list[GsaSlimNamedEntity]") -> None:
    ...
    def foreign_data_link_groups(self, foreign_data_link_groups: "list[GsaSlimNamedEntity]") -> None:
    ...
    def primary_dynamic_link_groups(self, primary_dynamic_link_groups: "Union[list[GsaSlimNamedEntity], None, Unset_Type]") -> None:
    ...
    def foreign_dynamic_link_groups(self, foreign_dynamic_link_groups: "Union[list[GsaSlimNamedEntity], None, Unset_Type]") -> None:
