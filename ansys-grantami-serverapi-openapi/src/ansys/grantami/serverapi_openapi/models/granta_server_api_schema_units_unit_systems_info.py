...
class GrantaServerApiSchemaUnitsUnitSystemsInfo(ModelBase):
    ...
    def __init__(self, *, unit_systems: "Optional[List[GrantaServerApiSchemaSlimEntitiesSlimUnitSystem]]" = None,) -> None:
    ...
    @property
    def unit_systems(self) -> "list[GrantaServerApiSchemaSlimEntitiesSlimUnitSystem]":
    ...
    @unit_systems.setter
    def unit_systems(self, unit_systems: "list[GrantaServerApiSchemaSlimEntitiesSlimUnitSystem]") -> None:
