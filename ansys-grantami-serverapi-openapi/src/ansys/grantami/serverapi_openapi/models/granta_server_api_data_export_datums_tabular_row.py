...
class GrantaServerApiDataExportDatumsTabularRow(ModelBase):
    ...
    @property
    def linked_records(self) -> "list[GrantaServerApiIntegrationDataExportRecordReference]":
    ...
    def linked_records(self, linked_records: "list[GrantaServerApiIntegrationDataExportRecordReference]") -> None:
