...
class GrantaServerApiSchemaSubsetsAddRecordHistoryToSubset(ModelBase):  # type: ignore[misc]
    ...
    @property
    def recurse_children(self) -> "Optional[bool]":
    ...
    def recurse_children(self, recurse_children: "Optional[bool]") -> None:
