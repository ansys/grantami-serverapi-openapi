...
class GsaDataExportSeriesPoint(ModelBase):
    ...
    def __init__(self, *, x_name: "Union[str, None, Unset_Type]" = Unset, x_value: "Union[float, Unset_Type]" = Unset, y_high_value: "Union[float, Unset_Type]" = Unset, y_low_value: "Union[float, Unset_Type]" = Unset,) -> None:
