...
class AttributesAttributeguidimportfileBody1(ModelBase):
    ...
    def __init__(self, *, allow_index: "Union[bool, Unset_Type]" = Unset, description: "Union[str, Unset_Type]" = Unset, file: "Union[Union[BinaryIO, pathlib.Path], Unset_Type]" = Unset, target: "Union[str, Unset_Type]" = Unset,) -> None:
