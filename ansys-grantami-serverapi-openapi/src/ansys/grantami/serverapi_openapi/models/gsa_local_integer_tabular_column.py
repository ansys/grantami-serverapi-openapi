...
class GsaLocalIntegerTabularColumn(GsaTabularColumn):
    ...
    def __init__(self, *, column_type: "GsaTabularColumnDtoType" = GsaTabularColumnDtoType.LOCALINTEGER, default_threshold_type: "GsaAttributeThresholdType", display_names: "dict[str, str]", guid: "str", name: "str", roll_up_type: "GsaTabularColumnRollUpType", show_as_link: "bool", summary_row_enabled: "bool", summary_row_roll_up_type: "GsaTabularColumnRollUpType", summary_row_text: "str",) -> None:
        """GsaLocalIntegerTabularColumn - a model defined in Swagger
    ...
    def default_threshold_type(self) -> "GsaAttributeThresholdType":
        """Gets the default_threshold_type of this GsaLocalIntegerTabularColumn.

        Returns
        -------
        GsaAttributeThresholdType
            The default_threshold_type of this GsaLocalIntegerTabularColumn.
        """
    ...
    def default_threshold_type(self, default_threshold_type: "GsaAttributeThresholdType") -> None:
        """Sets the default_threshold_type of this GsaLocalIntegerTabularColumn.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaLocalIntegerTabularColumn):
            return False
