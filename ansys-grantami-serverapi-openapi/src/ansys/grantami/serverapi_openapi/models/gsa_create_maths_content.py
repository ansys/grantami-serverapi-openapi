...
class GsaCreateMathsContent(ModelBase):
    ...
    def __init__(self, *, curve_label: "Union[str, None, Unset_Type]" = Unset, expression: "Union[GsaSlimEntity, Unset_Type]" = Unset, free_parameter: "Union[GsaSlimEntity, Unset_Type]" = Unset, parameter_contents: "Union[list[GsaCreateParameterContent], Unset_Type]" = Unset, transpose_axes: "Union[bool, Unset_Type]" = Unset, use_logarithmic_scale: "Union[bool, Unset_Type]" = Unset,) -> None:
    ...
    def parameter_contents(self, parameter_contents: "Union[list[GsaCreateParameterContent], Unset_Type]") -> None:
