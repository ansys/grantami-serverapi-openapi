...
class GrantaServerApiAggregationsIntegerAttributeAggregation(GrantaServerApiAggregationsAttributeValueAggregation):
    ...
    def __init__(self, *, attribute_aggregation_type: "str" = 'value', attribute_guid: "Optional[str]" = None, attribute_identity: "Optional[int]" = None, count: "Optional[int]" = None, datum_type: "str" = 'integer', maximum: "Optional[int]" = None, minimum: "Optional[int]" = None, type: "str" = 'attribute',) -> None:
        """GrantaServerApiAggregationsIntegerAttributeAggregation - a model defined in Swagger
    ...
    def minimum(self) -> "int":
        """Gets the minimum of this GrantaServerApiAggregationsIntegerAttributeAggregation.

        Returns
        -------
        int
            The minimum of this GrantaServerApiAggregationsIntegerAttributeAggregation.
        """
    ...
    def maximum(self) -> "int":
        """Gets the maximum of this GrantaServerApiAggregationsIntegerAttributeAggregation.

        Returns
        -------
        int
            The maximum of this GrantaServerApiAggregationsIntegerAttributeAggregation.
        """
    ...
    def datum_type(self) -> "str":
        """Gets the datum_type of this GrantaServerApiAggregationsIntegerAttributeAggregation.

        Returns
        -------
        str
            The datum_type of this GrantaServerApiAggregationsIntegerAttributeAggregation.
        """
