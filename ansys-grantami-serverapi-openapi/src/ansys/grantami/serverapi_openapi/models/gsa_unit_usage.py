...
class GsaUnitUsage(ModelBase):
    ...
    def __init__(self, *, attributes: "list[GsaSlimNamedEntity]", constants: "list[GsaSlimNamedEntity]", expressions: "list[GsaSlimNamedEntity]", parameters: "list[GsaSlimNamedEntity]", units: "list[GsaSlimUnit]",) -> None:
