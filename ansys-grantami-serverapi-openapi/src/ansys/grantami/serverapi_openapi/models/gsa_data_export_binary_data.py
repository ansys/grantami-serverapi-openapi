...
class GsaDataExportBinaryData(ModelBase):
    ...
    def __init__(self, *, content_type: "Union[str, None, Unset_Type]" = Unset, data: "Union[str, None, Unset_Type]" = Unset, description: "Union[str, None, Unset_Type]" = Unset, name: "Union[str, None, Unset_Type]" = Unset,) -> None:
