...
class GsaProfileTablesInfo(ModelBase):
    ...
    def __init__(self, *, profile_tables: "Union[list[GsaSlimProfileTable], None, Unset_Type]" = Unset,) -> None:
    ...
    def profile_tables(self, profile_tables: "Union[list[GsaSlimProfileTable], None, Unset_Type]") -> None:
