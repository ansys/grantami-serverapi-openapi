...
class GsaLocalRangeTabularColumn(GsaTabularColumn):
    ...
    def __init__(self, *, column_type: "GsaTabularColumnDtoType" = GsaTabularColumnDtoType.LOCALRANGE, default_threshold_type: "GsaAttributeThresholdType", display_names: "dict[str, str]", guid: "str", name: "str", roll_up_type: "GsaTabularColumnRollUpType", show_as_link: "bool", summary_row_enabled: "bool", summary_row_roll_up_type: "GsaTabularColumnRollUpType", summary_row_text: "str", unit: "Union[GsaSlimUnit, Unset_Type]" = Unset,) -> None:
    ...
    def default_threshold_type(self) -> "GsaAttributeThresholdType":
        """Gets the default_threshold_type of this GsaLocalRangeTabularColumn.

        Returns
        -------
        GsaAttributeThresholdType
            The default_threshold_type of this GsaLocalRangeTabularColumn.
        """
    ...
    def default_threshold_type(self, default_threshold_type: "GsaAttributeThresholdType") -> None:
        """Sets the default_threshold_type of this GsaLocalRangeTabularColumn.
    ...
    def unit(self) -> "Union[GsaSlimUnit, Unset_Type]":
        """Gets the unit of this GsaLocalRangeTabularColumn.

        Returns
        -------
        Union[GsaSlimUnit, Unset_Type]
            The unit of this GsaLocalRangeTabularColumn.
        """
        return self._unit

    @unit.setter
    def unit(self, unit: "Union[GsaSlimUnit, Unset_Type]") -> None:
        """Sets the unit of this GsaLocalRangeTabularColumn.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaLocalRangeTabularColumn):
            return False
