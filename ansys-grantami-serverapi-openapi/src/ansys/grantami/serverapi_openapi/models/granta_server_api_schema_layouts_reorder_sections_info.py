...
class GrantaServerApiSchemaLayoutsReorderSectionsInfo(ModelBase):  # type: ignore[misc]
    ...
    def __init__(
        ...
        *,
        ...
        ----------
            layout_sections: List[GrantaServerApiSchemaSlimEntitiesSlimEntity]
        """
        self._layout_sections: List[GrantaServerApiSchemaSlimEntitiesSlimEntity] = None  # type: ignore[assignment]
