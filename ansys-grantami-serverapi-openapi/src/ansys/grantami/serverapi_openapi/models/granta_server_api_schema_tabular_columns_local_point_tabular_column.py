...
class GrantaServerApiSchemaTabularColumnsLocalPointTabularColumn(GrantaServerApiSchemaTabularColumnsTabularColumn):
    ...
    def __init__(self, *, column_type: "str" = 'localPoint', default_threshold_type: "Optional[GrantaServerApiSchemaAttributesAttributeThresholdType]" = None, display_names: "Optional[Dict[str, str]]" = None, guid: "Optional[str]" = None, name: "Optional[str]" = None, roll_up_type: "Optional[GrantaServerApiSchemaTabularColumnsTabularColumnRollUpType]" = None, show_as_link: "Optional[bool]" = None, summary_row_enabled: "Optional[bool]" = None, summary_row_roll_up_type: "Optional[GrantaServerApiSchemaTabularColumnsTabularColumnRollUpType]" = None, summary_row_text: "Optional[str]" = None, unit: "Optional[GrantaServerApiSchemaSlimEntitiesSlimUnit]" = None,) -> None:
        """GrantaServerApiSchemaTabularColumnsLocalPointTabularColumn - a model defined in Swagger
    ...
    def column_type(self) -> "str":
        """Gets the column_type of this GrantaServerApiSchemaTabularColumnsLocalPointTabularColumn.

        Returns
        -------
        str
            The column_type of this GrantaServerApiSchemaTabularColumnsLocalPointTabularColumn.
        """
    ...
    def default_threshold_type(self) -> "GrantaServerApiSchemaAttributesAttributeThresholdType":
        """Gets the default_threshold_type of this GrantaServerApiSchemaTabularColumnsLocalPointTabularColumn.
    ...
    def unit(self) -> "GrantaServerApiSchemaSlimEntitiesSlimUnit":
        ...
        GrantaServerApiSchemaSlimEntitiesSlimUnit
            The unit of this GrantaServerApiSchemaTabularColumnsLocalPointTabularColumn.
        """
        return self._unit
