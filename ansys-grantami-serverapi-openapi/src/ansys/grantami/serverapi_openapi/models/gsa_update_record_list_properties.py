...
class GsaUpdateRecordListProperties(ModelBase):
    ...
    def __init__(self, *, awaiting_approval: "Union[bool, Unset_Type]" = Unset, description: "Union[str, None, Unset_Type]" = Unset, internal_use: "Union[bool, Unset_Type]" = Unset, name: "Union[str, None, Unset_Type]" = Unset, notes: "Union[str, None, Unset_Type]" = Unset, published: "Union[bool, Unset_Type]" = Unset,) -> None:
        """GsaUpdateRecordListProperties - a model defined in Swagger
    ...
    def name(self) -> "Union[str, None, Unset_Type]":
        """Gets the name of this GsaUpdateRecordListProperties.

        Returns
        -------
        Union[str, None, Unset_Type]
            The name of this GsaUpdateRecordListProperties.
        """
        return self._name

    @name.setter
    def name(self, name: "Union[str, None, Unset_Type]") -> None:
        """Sets the name of this GsaUpdateRecordListProperties.
    ...
    def description(self) -> "Union[str, None, Unset_Type]":
        """Gets the description of this GsaUpdateRecordListProperties.

        Returns
        -------
        Union[str, None, Unset_Type]
            The description of this GsaUpdateRecordListProperties.
        """
        return self._description

    @description.setter
    def description(self, description: "Union[str, None, Unset_Type]") -> None:
        """Sets the description of this GsaUpdateRecordListProperties.
    ...
    def notes(self) -> "Union[str, None, Unset_Type]":
        """Gets the notes of this GsaUpdateRecordListProperties.

        Returns
        -------
        Union[str, None, Unset_Type]
            The notes of this GsaUpdateRecordListProperties.
        """
        return self._notes

    @notes.setter
    def notes(self, notes: "Union[str, None, Unset_Type]") -> None:
        """Sets the notes of this GsaUpdateRecordListProperties.
    ...
    def published(self) -> "Union[bool, Unset_Type]":
        """Gets the published of this GsaUpdateRecordListProperties.

        Returns
        -------
        Union[bool, Unset_Type]
            The published of this GsaUpdateRecordListProperties.
        """
        return self._published

    @published.setter
    def published(self, published: "Union[bool, Unset_Type]") -> None:
        """Sets the published of this GsaUpdateRecordListProperties.
    ...
    def awaiting_approval(self) -> "Union[bool, Unset_Type]":
        """Gets the awaiting_approval of this GsaUpdateRecordListProperties.

        Returns
        -------
        Union[bool, Unset_Type]
            The awaiting_approval of this GsaUpdateRecordListProperties.
        """
    ...
    def awaiting_approval(self, awaiting_approval: "Union[bool, Unset_Type]") -> None:
        """Sets the awaiting_approval of this GsaUpdateRecordListProperties.
    ...
    def internal_use(self) -> "Union[bool, Unset_Type]":
        """Gets the internal_use of this GsaUpdateRecordListProperties.

        Returns
        -------
        Union[bool, Unset_Type]
            The internal_use of this GsaUpdateRecordListProperties.
        """
        return self._internal_use

    @internal_use.setter
    def internal_use(self, internal_use: "Union[bool, Unset_Type]") -> None:
        """Sets the internal_use of this GsaUpdateRecordListProperties.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaUpdateRecordListProperties):
            return False
