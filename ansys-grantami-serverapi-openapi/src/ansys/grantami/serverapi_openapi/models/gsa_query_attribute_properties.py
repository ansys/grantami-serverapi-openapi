...
class GsaQueryAttributeProperties(ModelBase):
    ...
    def __init__(self, *, about_attribute: "Union[GsaQuerySlimTypedAttributeProperties, Unset_Type]" = Unset, attribute_parameters: "Union[GsaQuerySlimNamedEntityProperties, Unset_Type]" = Unset, axis_name: "Union[GsaQueryAxisNameProperties, Unset_Type]" = Unset, data_rule: "Union[GsaQueryDataRuleProperties, Unset_Type]" = Unset, default_threshold_type: "Union[bool, None, Unset_Type]" = Unset, discrete_type: "Union[GsaQuerySlimDiscreteTypeProperties, Unset_Type]" = Unset, display_names: "Union[bool, None, Unset_Type]" = Unset, expressions: "Union[GsaQuerySlimNamedEntityProperties, Unset_Type]" = Unset, guid: "Union[bool, None, Unset_Type]" = Unset, info: "Union[GsaQueryAttributeInfoProperties, Unset_Type]" = Unset, is_functional_range: "Union[bool, None, Unset_Type]" = Unset, is_hidden_from_search_criteria: "Union[bool, None, Unset_Type]" = Unset, is_multi_valued: "Union[bool, None, Unset_Type]" = Unset, name: "Union[bool, None, Unset_Type]" = Unset, tabular_columns: "Union[GsaQuerySlimNamedEntityProperties, Unset_Type]" = Unset, target: "Union[GsaQueryTabularAttributeTargetProperties, Unset_Type]" = Unset, type: "Union[bool, None, Unset_Type]" = Unset, unit: "Union[GsaQueryUnitProperties, Unset_Type]" = Unset,) -> None:
    ...
    def default_threshold_type(self, default_threshold_type: "Union[bool, None, Unset_Type]") -> None:
    ...
    def is_hidden_from_search_criteria(self, is_hidden_from_search_criteria: "Union[bool, None, Unset_Type]") -> None:
    ...
    def discrete_type(self, discrete_type: "Union[GsaQuerySlimDiscreteTypeProperties, Unset_Type]") -> None:
    ...
    def about_attribute(self, about_attribute: "Union[GsaQuerySlimTypedAttributeProperties, Unset_Type]") -> None:
    ...
    def tabular_columns(self, tabular_columns: "Union[GsaQuerySlimNamedEntityProperties, Unset_Type]") -> None:
    ...
    def attribute_parameters(self, attribute_parameters: "Union[GsaQuerySlimNamedEntityProperties, Unset_Type]") -> None:
    ...
    @expressions.setter
    def expressions(self, expressions: "Union[GsaQuerySlimNamedEntityProperties, Unset_Type]") -> None:
