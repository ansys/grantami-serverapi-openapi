...
class GrantaServerApiAsyncJobsJob(ModelBase):
    ...
    def submitter_name(self, submitter_name: "str") -> None:
    ...
    @property
    def submitter_roles(self) -> "list[str]":
    ...
    def submitter_roles(self, submitter_roles: "list[str]") -> None:
    ...
    def execution_date(self, execution_date: "datetime") -> None:
    ...
    def output_file_names(self, output_file_names: "list[str]") -> None:
    ...
    @property
    def job_specific_outputs(self) -> "dict(str, object)":
    ...
    def job_specific_outputs(self, job_specific_outputs: "dict(str, object)") -> None:
    ...
    def to_dict(self) -> Dict:
        ...
        for attr in self.swagger_types.keys():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GrantaServerApiAsyncJobsJob, dict):
