...
class GrantaServerApiDataExportExportFailuresExportFailure(ModelBase):  # type: ignore[misc]
    ...
    def __init__(
        ...
        *,
        ...
        ----------
            ...
            failure_reason: str
        """
        self._failure_details: str = None  # type: ignore[assignment]
        self._failure_reason: str = None  # type: ignore[assignment]
