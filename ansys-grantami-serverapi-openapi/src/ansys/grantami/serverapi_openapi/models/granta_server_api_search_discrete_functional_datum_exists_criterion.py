...
class GrantaServerApiSearchDiscreteFunctionalDatumExistsCriterion(GrantaServerApiSearchDatumExistsCriterion):
    ...
    def __init__(self, *, type: "str" = 'discreteFunctional',) -> None:
