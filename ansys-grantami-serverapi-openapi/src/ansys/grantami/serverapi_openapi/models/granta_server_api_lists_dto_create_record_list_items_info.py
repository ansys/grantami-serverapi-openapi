...
class GrantaServerApiListsDtoCreateRecordListItemsInfo(ModelBase):  # type: ignore[misc]
    ...
    def __init__(
        ...
        *,
        ...
        ----------
            items: List[GrantaServerApiListsDtoCreateListItem]
        """
        self._items: List[GrantaServerApiListsDtoCreateListItem] = None  # type: ignore[assignment]
