...
class GrantaServerApiSchemaLayoutsLayoutTabularColumn(ModelBase):  # type: ignore[misc]
    ...
    def __init__(
        ...
        *,
        ...
        ----------
            ...
            tabular_column_guid: str
        """
        self._column_type: GrantaServerApiSchemaTabularColumnsTabularColumnDtoType = None  # type: ignore[assignment]
        self._tabular_column_guid: str = None  # type: ignore[assignment]
