...
class GrantaServerApiSearchSearchRequest(ModelBase):
    ...
    def sort_criteria(self, sort_criteria: "list[GrantaServerApiSearchSortCriterion]") -> None:
    ...
    def paging_options(self, paging_options: "GrantaServerApiSearchPagingOptions") -> None:
