...
class GrantaServerApiSelectionSearchesSelectionSearch(ModelBase):
    ...
    @property
    def current_user_access_info(self) -> "dict(str, dict(str, bool))":
    ...
    def current_user_access_info(
        self, current_user_access_info: "dict(str, dict(str, bool))"
    ) -> None:
    ...
    def explore_config(self, explore_config: "str") -> None:
    ...
    @property
    def created_user_or_group(self) -> "GrantaServerApiSelectionSearchesUserOrGroup":
    ...
    def created_user_or_group(
        self, created_user_or_group: "GrantaServerApiSelectionSearchesUserOrGroup"
    ) -> None:
    ...
    def last_modified_user_or_group(
        self, last_modified_user_or_group: "GrantaServerApiSelectionSearchesUserOrGroup"
    ) -> None:
    ...
    def to_dict(self) -> Dict:
        ...
        for attr in self.swagger_types.keys():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GrantaServerApiSelectionSearchesSelectionSearch, dict):
