...
class GsaCreateConfiguration(ModelBase):
    ...
    def __init__(self, *, name: "str", value: "str", description: "Union[str, None, Unset_Type]" = Unset, guid: "Union[str, Unset_Type]" = Unset,) -> None:
        """GsaCreateConfiguration - a model defined in Swagger
    ...
    @property
    def name(self) -> "str":
        """Gets the name of this GsaCreateConfiguration.

        Returns
        -------
        str
            The name of this GsaCreateConfiguration.
        """
        return self._name

    @name.setter
    def name(self, name: "str") -> None:
        """Sets the name of this GsaCreateConfiguration.
    ...
    def guid(self) -> "Union[str, Unset_Type]":
        """Gets the guid of this GsaCreateConfiguration.

        Returns
        -------
        Union[str, Unset_Type]
            The guid of this GsaCreateConfiguration.
        """
        return self._guid

    @guid.setter
    def guid(self, guid: "Union[str, Unset_Type]") -> None:
        """Sets the guid of this GsaCreateConfiguration.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaCreateConfiguration):
            return False
