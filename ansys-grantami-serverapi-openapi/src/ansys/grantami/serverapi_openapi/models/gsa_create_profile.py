...
class GsaCreateProfile(ModelBase):
    ...
    def __init__(self, *, name: "str", description: "Union[str, None, Unset_Type]" = Unset, group_name: "Union[str, None, Unset_Type]" = Unset, guid: "Union[str, Unset_Type]" = Unset, homepage_url: "Union[str, None, Unset_Type]" = Unset,) -> None:
