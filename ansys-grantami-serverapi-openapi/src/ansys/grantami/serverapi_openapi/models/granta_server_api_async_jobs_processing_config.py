...
class GrantaServerApiAsyncJobsProcessingConfig(ModelBase):
    ...
    def purge_job_age_in_milliseconds(
        self, purge_job_age_in_milliseconds: "int"
    ) -> None:
    ...
    def purge_interval_in_milliseconds(
        self, purge_interval_in_milliseconds: "int"
    ) -> None:
    ...
    def polling_interval_in_milliseconds(
        self, polling_interval_in_milliseconds: "int"
    ) -> None:
    ...
    def to_dict(self) -> Dict:
        ...
        for attr in self.swagger_types.keys():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GrantaServerApiAsyncJobsProcessingConfig, dict):
