...
class GsaRecordListSearchInfo(ModelBase):
    ...
    def __init__(self, *, search_result_identifier: "str",) -> None:
        """GsaRecordListSearchInfo - a model defined in Swagger
    ...
    def search_result_identifier(self) -> "str":
        """Gets the search_result_identifier of this GsaRecordListSearchInfo.

        Returns
        -------
        str
            The search_result_identifier of this GsaRecordListSearchInfo.
        """
    ...
    def search_result_identifier(self, search_result_identifier: "str") -> None:
        """Sets the search_result_identifier of this GsaRecordListSearchInfo.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaRecordListSearchInfo):
            return False
