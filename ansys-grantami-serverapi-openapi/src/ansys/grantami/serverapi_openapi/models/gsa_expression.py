...
class GsaExpression(ModelBase):
    ...
    def __init__(self, *, attribute_dependencies: "list[GsaSlimAttribute]", constant_dependencies: "list[GsaSlimNamedEntity]", guid: "str", name: "str", parameter_dependencies: "list[GsaSlimNamedEntity]", value: "str", unit: "Union[GsaSlimUnit, Unset_Type]" = Unset,) -> None:
