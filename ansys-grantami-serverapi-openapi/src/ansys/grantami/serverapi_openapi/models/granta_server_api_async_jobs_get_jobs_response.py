...
class GrantaServerApiAsyncJobsGetJobsResponse(ModelBase):
    ...
    @property
    def results(self) -> "list[GrantaServerApiAsyncJobsJob]":
    ...
    @results.setter
    def results(self, results: "list[GrantaServerApiAsyncJobsJob]") -> None:
    ...
    def to_dict(self) -> Dict:
        ...
        for attr in self.swagger_types.keys():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GrantaServerApiAsyncJobsGetJobsResponse, dict):
