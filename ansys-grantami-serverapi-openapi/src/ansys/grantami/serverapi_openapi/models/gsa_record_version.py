...
class GsaRecordVersion(ModelBase):
    ...
    def __init__(self, *, capabilities: "GsaRecordCapabilities", created_by_user: "str", created_date: "datetime", database_key: "str", guid: "str", last_modified_by_user: "str", last_modified_date: "datetime", name: "str", record_color: "GsaRecordColor", record_history: "GsaSlimRecordHistory", record_type: "GsaRecordType", short_name: "str", table: "GsaSlimTable", version_number: "int", version_state: "GsaVersionState", released_date: "Union[datetime, None, Unset_Type]" = Unset,) -> None:
