...
class GsaSortingValue(ModelBase):
    ...
    discriminator_value_class_map = {
        "double".lower(): "#/components/schemas/GsaDoubleSortingValue",
        "long".lower(): "#/components/schemas/GsaLongSortingValue",
        "text".lower(): "#/components/schemas/GsaStringSortingValue",
    }

    discriminator: Optional[str] = "type"

    def __init__(self, *, type: "GsaSortingValueType",) -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaSortingValue):
            return False
