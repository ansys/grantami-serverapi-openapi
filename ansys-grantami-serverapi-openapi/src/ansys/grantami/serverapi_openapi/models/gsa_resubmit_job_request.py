...
class GsaResubmitJobRequest(ModelBase):
    ...
    def __init__(self, *, description: "Union[str, None, Unset_Type]" = Unset, name: "Union[str, None, Unset_Type]" = Unset, scheduled_execution_date: "Union[datetime, None, Unset_Type]" = Unset,) -> None:
        """GsaResubmitJobRequest - a model defined in Swagger
    ...
    def name(self) -> "Union[str, None, Unset_Type]":
        """Gets the name of this GsaResubmitJobRequest.

        Returns
        -------
        Union[str, None, Unset_Type]
            The name of this GsaResubmitJobRequest.
        """
        return self._name

    @name.setter
    def name(self, name: "Union[str, None, Unset_Type]") -> None:
        """Sets the name of this GsaResubmitJobRequest.
    ...
    def description(self) -> "Union[str, None, Unset_Type]":
        """Gets the description of this GsaResubmitJobRequest.

        Returns
        -------
        Union[str, None, Unset_Type]
            The description of this GsaResubmitJobRequest.
        """
        return self._description

    @description.setter
    def description(self, description: "Union[str, None, Unset_Type]") -> None:
        """Sets the description of this GsaResubmitJobRequest.
    ...
    def scheduled_execution_date(self) -> "Union[datetime, None, Unset_Type]":
        """Gets the scheduled_execution_date of this GsaResubmitJobRequest.

        Returns
        -------
        Union[datetime, None, Unset_Type]
            The scheduled_execution_date of this GsaResubmitJobRequest.
        """
    ...
    def scheduled_execution_date(self, scheduled_execution_date: "Union[datetime, None, Unset_Type]") -> None:
        """Sets the scheduled_execution_date of this GsaResubmitJobRequest.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaResubmitJobRequest):
            return False
