...
class GrantaServerApiSchemaParametersDiscreteRange(ModelBase):  # type: ignore[misc]
    ...
    def __init__(
        ...
        *,
        ...
        ----------
            parameter_values: List[GrantaServerApiSchemaSlimEntitiesSlimNamedEntity]
        """
        self._parameter_values: List[GrantaServerApiSchemaSlimEntitiesSlimNamedEntity] = None  # type: ignore[assignment]
