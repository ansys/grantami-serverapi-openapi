...
class GsaDiscreteType(ModelBase):
    ...
    def __init__(self, *, discrete_values: "list[GsaDiscreteValuesDiscreteValue]", guid: "str", is_ordered: "bool", name: "str",) -> None:
    ...
    def is_ordered(self) -> "bool":
        ...
        -------
        bool
            The is_ordered of this GsaDiscreteType.
        """
        return self._is_ordered

    @is_ordered.setter
    def is_ordered(self, is_ordered: "bool") -> None:
        """Sets the is_ordered of this GsaDiscreteType.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaDiscreteType):
            return False
