...
class GrantaServerApiIntegrationSchemaSourceOfGrantaServerApiObjectIdentifier(ModelBase):
    ...
    @property
    def mappings(self) -> "list[GrantaServerApiIntegrationSchemaMappingOfGrantaServerApiObjectIdentifier]":
    ...
    @mappings.setter
    def mappings(self, mappings: "list[GrantaServerApiIntegrationSchemaMappingOfGrantaServerApiObjectIdentifier]") -> None:
