...
class GsaLayoutSection(ModelBase):
    ...
    discriminator_value_class_map = {
        "slim".lower(): "#/components/schemas/GsaSlimLayoutSection",
        "full".lower(): "#/components/schemas/GsaFullLayoutSection",
    }

    discriminator: Optional[str] = "sectionDetailType"

    def __init__(self, *, display_names: "dict[str, str]", guid: "str", name: "str", section_detail_type: "GsaLayoutSectionDetailType",) -> None:
        """GsaLayoutSection - a model defined in Swagger
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaLayoutSection):
            return False
