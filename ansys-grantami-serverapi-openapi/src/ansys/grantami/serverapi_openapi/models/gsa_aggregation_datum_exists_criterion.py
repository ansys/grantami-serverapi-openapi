...
class GsaAggregationDatumExistsCriterion(ModelBase):
    ...
    def __init__(self, *, type: "Union[GsaAttributeType, Unset_Type]" = Unset,) -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaAggregationDatumExistsCriterion):
            return False
