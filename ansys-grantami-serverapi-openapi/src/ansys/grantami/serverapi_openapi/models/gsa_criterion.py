...
class GsaCriterion(ModelBase):
    ...
    discriminator_value_class_map = {
        ...
        "localColumn".lower(): "#/components/schemas/GsaLocalColumnCriterion",
        "namedCriterion".lower(): "#/components/schemas/GsaNamedCriterion",
    }

    discriminator: Optional[str] = "type"

    def __init__(self, *, type: "GsaCriterionType",) -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaCriterion):
            return False
