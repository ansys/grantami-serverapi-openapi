...
class GsaNewLayoutAssociationChainLink(ModelBase):
    ...
    def __init__(self, *, source_database_version_guid: "str", tabular_attribute_guid: "str", forwards: "Union[bool, Unset_Type]" = Unset,) -> None:
        """GsaNewLayoutAssociationChainLink - a model defined in Swagger
    ...
    def forwards(self) -> "Union[bool, Unset_Type]":
        """Gets the forwards of this GsaNewLayoutAssociationChainLink.

        Returns
        -------
        Union[bool, Unset_Type]
            The forwards of this GsaNewLayoutAssociationChainLink.
        """
        return self._forwards

    @forwards.setter
    def forwards(self, forwards: "Union[bool, Unset_Type]") -> None:
        """Sets the forwards of this GsaNewLayoutAssociationChainLink.
    ...
    def source_database_version_guid(self) -> "str":
        """Gets the source_database_version_guid of this GsaNewLayoutAssociationChainLink.

        Returns
        -------
        str
            The source_database_version_guid of this GsaNewLayoutAssociationChainLink.
        """
    ...
    def source_database_version_guid(self, source_database_version_guid: "str") -> None:
        """Sets the source_database_version_guid of this GsaNewLayoutAssociationChainLink.
        ...
        if source_database_version_guid is Unset:  # type: ignore[comparison-overlap, unused-ignore]
            raise ValueError("Invalid value for 'source_database_version_guid', must not be 'Unset'")
        self._source_database_version_guid = source_database_version_guid

    @property
    def tabular_attribute_guid(self) -> "str":
        """Gets the tabular_attribute_guid of this GsaNewLayoutAssociationChainLink.

        Returns
        -------
        str
            The tabular_attribute_guid of this GsaNewLayoutAssociationChainLink.
        """
    ...
    def tabular_attribute_guid(self, tabular_attribute_guid: "str") -> None:
        """Sets the tabular_attribute_guid of this GsaNewLayoutAssociationChainLink.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaNewLayoutAssociationChainLink):
            return False
