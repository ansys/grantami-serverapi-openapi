...
class GrantaServerApiAggregationsFloatFunctionalAttributeAggregation(
    GrantaServerApiAggregationsAttributeValueAggregation
):
    ...
    def to_dict(self) -> Dict:
        ...
        for attr in self.swagger_types.keys():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(
            GrantaServerApiAggregationsFloatFunctionalAttributeAggregation, dict
        ):
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(
            other, GrantaServerApiAggregationsFloatFunctionalAttributeAggregation
        ):
            return False
