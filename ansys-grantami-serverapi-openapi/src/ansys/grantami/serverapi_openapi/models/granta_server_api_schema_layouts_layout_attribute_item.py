...
from ansys.grantami.serverapi_openapi.models.granta_server_api_schema_layouts_layout_item import GrantaServerApiSchemaLayoutsLayoutItem  # noqa: F401
...
class GrantaServerApiSchemaLayoutsLayoutAttributeItem(GrantaServerApiSchemaLayoutsLayoutItem):
    ...
    @property
    def meta_attributes(self) -> "list[GrantaServerApiSchemaLayoutsLayoutAttributeItem]":
    ...
    def meta_attributes(self, meta_attributes: "list[GrantaServerApiSchemaLayoutsLayoutAttributeItem]") -> None:
    ...
    @property
    def tabular_columns(self) -> "list[GrantaServerApiSchemaLayoutsLayoutTabularColumn]":
    ...
    def tabular_columns(self, tabular_columns: "list[GrantaServerApiSchemaLayoutsLayoutTabularColumn]") -> None:
