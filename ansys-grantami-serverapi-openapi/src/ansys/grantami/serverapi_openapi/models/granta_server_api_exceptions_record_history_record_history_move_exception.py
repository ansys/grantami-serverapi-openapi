...
class GrantaServerApiExceptionsRecordHistoryRecordHistoryMoveException(ModelBase):  # type: ignore[misc]
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(
            other, GrantaServerApiExceptionsRecordHistoryRecordHistoryMoveException
        ):
            return False
