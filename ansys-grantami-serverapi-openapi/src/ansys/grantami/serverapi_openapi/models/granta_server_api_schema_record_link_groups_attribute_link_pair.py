...
class GrantaServerApiSchemaRecordLinkGroupsAttributeLinkPair(ModelBase):
    ...
    def attribute_source(self, attribute_source: "GrantaServerApiSchemaSlimEntitiesSlimAttribute") -> None:
    ...
    def attribute_target(self, attribute_target: "GrantaServerApiSchemaSlimEntitiesSlimAttribute") -> None:
