...
class GsaLocalPointTabularColumn(GsaTabularColumn):
    ...
    def __init__(self, *, column_type: "GsaTabularColumnDtoType" = GsaTabularColumnDtoType.LOCALPOINT, default_threshold_type: "GsaAttributeThresholdType", display_names: "dict[str, str]", guid: "str", name: "str", roll_up_type: "GsaTabularColumnRollUpType", show_as_link: "bool", summary_row_enabled: "bool", summary_row_roll_up_type: "GsaTabularColumnRollUpType", summary_row_text: "str", unit: "Union[GsaSlimUnit, Unset_Type]" = Unset,) -> None:
        """GsaLocalPointTabularColumn - a model defined in Swagger
    ...
    def default_threshold_type(self) -> "GsaAttributeThresholdType":
        """Gets the default_threshold_type of this GsaLocalPointTabularColumn.

        Returns
        -------
        GsaAttributeThresholdType
            The default_threshold_type of this GsaLocalPointTabularColumn.
        """
    ...
    def default_threshold_type(self, default_threshold_type: "GsaAttributeThresholdType") -> None:
        """Sets the default_threshold_type of this GsaLocalPointTabularColumn.
    ...
    def unit(self) -> "Union[GsaSlimUnit, Unset_Type]":
        """Gets the unit of this GsaLocalPointTabularColumn.

        Returns
        -------
        Union[GsaSlimUnit, Unset_Type]
            The unit of this GsaLocalPointTabularColumn.
        """
        return self._unit

    @unit.setter
    def unit(self, unit: "Union[GsaSlimUnit, Unset_Type]") -> None:
        """Sets the unit of this GsaLocalPointTabularColumn.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaLocalPointTabularColumn):
            return False
