...
class GsaLayoutTabularColumn(ModelBase):
    ...
    def __init__(self, *, column_type: "GsaTabularColumnDtoType", guid: "str", name: "str", tabular_column_guid: "str",) -> None:
        """GsaLayoutTabularColumn - a model defined in Swagger
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaLayoutTabularColumn):
            return False
