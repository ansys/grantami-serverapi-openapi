...
class GsaSlimTable(ModelBase):
    ...
    def __init__(self, *, display_names: "dict[str, str]", guid: "str", is_hidden_from_browse: "bool", is_hidden_from_search: "bool", is_versioned: "bool", name: "str", table_types: "list[str]",) -> None:
