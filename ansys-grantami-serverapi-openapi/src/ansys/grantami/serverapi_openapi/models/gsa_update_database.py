...
class GsaUpdateDatabase(ModelBase):
    ...
    def __init__(self, *, additional_sql_parameters: "Union[str, None, Unset_Type]" = Unset, author: "Union[str, None, Unset_Type]" = Unset, company: "Union[str, None, Unset_Type]" = Unset, currency_code: "Union[str, None, Unset_Type]" = Unset, data_source: "Union[str, None, Unset_Type]" = Unset, database_key: "Union[str, None, Unset_Type]" = Unset, guid: "Union[str, Unset_Type]" = Unset, initial_catalog: "Union[str, None, Unset_Type]" = Unset, is_read_only: "Union[bool, Unset_Type]" = Unset, language: "Union[str, None, Unset_Type]" = Unset, loading_order: "Union[int, Unset_Type]" = Unset, name: "Union[str, Unset_Type]" = Unset, notes: "Union[str, None, Unset_Type]" = Unset, sql_password: "Union[str, None, Unset_Type]" = Unset, sql_user_name: "Union[str, None, Unset_Type]" = Unset, use_integrated_security: "Union[bool, None, Unset_Type]" = Unset, version_guid: "Union[str, Unset_Type]" = Unset,) -> None:
    ...
    def use_integrated_security(self, use_integrated_security: "Union[bool, None, Unset_Type]") -> None:
    ...
    def additional_sql_parameters(self, additional_sql_parameters: "Union[str, None, Unset_Type]") -> None:
