...
class GsaCreateRecordList(ModelBase):
    ...
    def __init__(self, *, name: "str", awaiting_approval: "Union[bool, Unset_Type]" = Unset, description: "Union[str, None, Unset_Type]" = Unset, identifier: "Union[str, None, Unset_Type]" = Unset, internal_use: "Union[bool, Unset_Type]" = Unset, items: "Union[GsaCreateRecordListItemsInfo, Unset_Type]" = Unset, notes: "Union[str, None, Unset_Type]" = Unset, published: "Union[bool, Unset_Type]" = Unset,) -> None:
        """GsaCreateRecordList - a model defined in Swagger
        ...
        items: GsaCreateRecordListItemsInfo, optional
        notes: str, optional
        published: bool, optional
        """
        self._items: Union[GsaCreateRecordListItemsInfo, Unset_Type] = Unset
    ...
    @property
    def items(self) -> "Union[GsaCreateRecordListItemsInfo, Unset_Type]":
        """Gets the items of this GsaCreateRecordList.

        Returns
        -------
        Union[GsaCreateRecordListItemsInfo, Unset_Type]
            The items of this GsaCreateRecordList.
        """
        return self._items

    @items.setter
    def items(self, items: "Union[GsaCreateRecordListItemsInfo, Unset_Type]") -> None:
        """Sets the items of this GsaCreateRecordList.

        Parameters
        ----------
        items: Union[GsaCreateRecordListItemsInfo, Unset_Type]
            The items of this GsaCreateRecordList.
        """
    ...
    def identifier(self) -> "Union[str, None, Unset_Type]":
        """Gets the identifier of this GsaCreateRecordList.

        Returns
        -------
        Union[str, None, Unset_Type]
            The identifier of this GsaCreateRecordList.
        """
        return self._identifier

    @identifier.setter
    def identifier(self, identifier: "Union[str, None, Unset_Type]") -> None:
        """Sets the identifier of this GsaCreateRecordList.
    ...
    @property
    def name(self) -> "str":
        """Gets the name of this GsaCreateRecordList.

        Returns
        -------
        str
            The name of this GsaCreateRecordList.
        """
        return self._name

    @name.setter
    def name(self, name: "str") -> None:
        """Sets the name of this GsaCreateRecordList.
    ...
    def description(self) -> "Union[str, None, Unset_Type]":
        """Gets the description of this GsaCreateRecordList.

        Returns
        -------
        Union[str, None, Unset_Type]
            The description of this GsaCreateRecordList.
        """
        return self._description

    @description.setter
    def description(self, description: "Union[str, None, Unset_Type]") -> None:
        """Sets the description of this GsaCreateRecordList.
    ...
    def notes(self) -> "Union[str, None, Unset_Type]":
        """Gets the notes of this GsaCreateRecordList.

        Returns
        -------
        Union[str, None, Unset_Type]
            The notes of this GsaCreateRecordList.
        """
        return self._notes

    @notes.setter
    def notes(self, notes: "Union[str, None, Unset_Type]") -> None:
        """Sets the notes of this GsaCreateRecordList.
    ...
    def published(self) -> "Union[bool, Unset_Type]":
        """Gets the published of this GsaCreateRecordList.

        Returns
        -------
        Union[bool, Unset_Type]
            The published of this GsaCreateRecordList.
        """
        return self._published

    @published.setter
    def published(self, published: "Union[bool, Unset_Type]") -> None:
        """Sets the published of this GsaCreateRecordList.
    ...
    def awaiting_approval(self) -> "Union[bool, Unset_Type]":
        """Gets the awaiting_approval of this GsaCreateRecordList.

        Returns
        -------
        Union[bool, Unset_Type]
            The awaiting_approval of this GsaCreateRecordList.
        """
    ...
    def awaiting_approval(self, awaiting_approval: "Union[bool, Unset_Type]") -> None:
        """Sets the awaiting_approval of this GsaCreateRecordList.
    ...
    def internal_use(self) -> "Union[bool, Unset_Type]":
        """Gets the internal_use of this GsaCreateRecordList.

        Returns
        -------
        Union[bool, Unset_Type]
            The internal_use of this GsaCreateRecordList.
        """
        return self._internal_use

    @internal_use.setter
    def internal_use(self, internal_use: "Union[bool, Unset_Type]") -> None:
        """Sets the internal_use of this GsaCreateRecordList.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaCreateRecordList):
            return False
