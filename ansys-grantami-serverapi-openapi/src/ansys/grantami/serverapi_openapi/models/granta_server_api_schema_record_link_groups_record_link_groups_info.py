...
class GrantaServerApiSchemaRecordLinkGroupsRecordLinkGroupsInfo(ModelBase):
    ...
    @property
    def record_link_groups(self) -> "list[GrantaServerApiSchemaSlimEntitiesSlimRecordLinkGroup]":
    ...
    def record_link_groups(self, record_link_groups: "list[GrantaServerApiSchemaSlimEntitiesSlimRecordLinkGroup]") -> None:
