...
class GrantaServerApiAggregationsLinkAggregationDatumCriterion(GrantaServerApiAggregationsAggregationDatumCriterion):
    ...
    @property
    def local_aggregation_criteria(self) -> "list[GrantaServerApiAggregationsAggregationCriterion]":
    ...
    def local_aggregation_criteria(self, local_aggregation_criteria: "list[GrantaServerApiAggregationsAggregationCriterion]") -> None:
