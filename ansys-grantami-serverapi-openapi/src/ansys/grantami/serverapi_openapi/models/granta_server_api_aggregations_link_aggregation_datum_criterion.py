...
class GrantaServerApiAggregationsLinkAggregationDatumCriterion(GrantaServerApiAggregationsAggregationDatumCriterion):
    ...
    @property
    def type(self):
        """Gets the type of this GrantaServerApiAggregationsLinkAggregationDatumCriterion.  # noqa: E501

        :return: The type of this GrantaServerApiAggregationsLinkAggregationDatumCriterion.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this GrantaServerApiAggregationsLinkAggregationDatumCriterion.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def local_aggregation_criteria(self):
        """Gets the local_aggregation_criteria of this GrantaServerApiAggregationsLinkAggregationDatumCriterion.  # noqa: E501

        :return: The local_aggregation_criteria of this GrantaServerApiAggregationsLinkAggregationDatumCriterion.  # noqa: E501
        :rtype: list[GrantaServerApiAggregationsAggregationCriterion]
        """
        return self._local_aggregation_criteria

    @local_aggregation_criteria.setter
    def local_aggregation_criteria(self, local_aggregation_criteria):
        """Sets the local_aggregation_criteria of this GrantaServerApiAggregationsLinkAggregationDatumCriterion.

        :param local_aggregation_criteria: The local_aggregation_criteria of this GrantaServerApiAggregationsLinkAggregationDatumCriterion.  # noqa: E501
