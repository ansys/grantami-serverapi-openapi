...
class GrantaServerApiSearchCriterion(ModelBase):  # type: ignore[misc]
    ...
    discriminator_value_class_map = {
        ...
        "recordAncestorIdentities".lower(): "#/components/schemas/GrantaServerApiSearchRecordAncestorHistoryIdentitiesCriterion",
