...
class GsaTabularColumn(ModelBase):
    ...
    def __init__(self, *, column_type: "GsaTabularColumnDtoType", display_names: "dict[str, str]", guid: "str", name: "str", roll_up_type: "GsaTabularColumnRollUpType", show_as_link: "bool", summary_row_enabled: "bool", summary_row_roll_up_type: "GsaTabularColumnRollUpType", summary_row_text: "str",) -> None:
    ...
    def summary_row_roll_up_type(self, summary_row_roll_up_type: "GsaTabularColumnRollUpType") -> None:
