...
class GrantaServerApiSchemaAttributesAttributesInfo(ModelBase):
    ...
    def __init__(self, *, attributes: "Optional[List[GrantaServerApiSchemaSlimEntitiesSlimAttribute]]" = None,) -> None:
    ...
    @attributes.setter
    def attributes(self, attributes: "list[GrantaServerApiSchemaSlimEntitiesSlimAttribute]") -> None:
