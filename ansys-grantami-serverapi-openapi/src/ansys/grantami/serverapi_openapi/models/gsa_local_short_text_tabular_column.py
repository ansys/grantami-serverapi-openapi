...
class GsaLocalShortTextTabularColumn(GsaTabularColumn):
    ...
    def __init__(self, *, column_type: "GsaTabularColumnDtoType" = GsaTabularColumnDtoType.LOCALSHORTTEXT, default_threshold_type: "GsaAttributeThresholdType", display_names: "dict[str, str]", guid: "str", name: "str", roll_up_type: "GsaTabularColumnRollUpType", show_as_link: "bool", summary_row_enabled: "bool", summary_row_roll_up_type: "GsaTabularColumnRollUpType", summary_row_text: "str",) -> None:
        """GsaLocalShortTextTabularColumn - a model defined in Swagger
    ...
    def default_threshold_type(self) -> "GsaAttributeThresholdType":
        """Gets the default_threshold_type of this GsaLocalShortTextTabularColumn.

        Returns
        -------
        GsaAttributeThresholdType
            The default_threshold_type of this GsaLocalShortTextTabularColumn.
        """
    ...
    def default_threshold_type(self, default_threshold_type: "GsaAttributeThresholdType") -> None:
        """Sets the default_threshold_type of this GsaLocalShortTextTabularColumn.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaLocalShortTextTabularColumn):
            return False
