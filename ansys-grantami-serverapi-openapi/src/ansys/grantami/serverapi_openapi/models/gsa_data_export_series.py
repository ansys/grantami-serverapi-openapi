...
class GsaDataExportSeries(ModelBase):
    ...
    def __init__(self, *, graph_decoration: "Union[GsaDataExportGraphDecoration, Unset_Type]" = Unset, parameter_values: "Union[list[GsaDataExportParameterValue], None, Unset_Type]" = Unset, points: "Union[list[GsaDataExportSeriesPoint], None, Unset_Type]" = Unset,) -> None:
