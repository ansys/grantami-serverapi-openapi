...
class GrantaServerApiDataExportDatumsPictureDatum(GrantaServerApiDataExportDatumsApplicableDatum):
    ...
    def __init__(self, *, attribute_guid: "Optional[str]" = None, attribute_identity: "Optional[int]" = None, datum_type: "str" = 'picture', datum_value: "Optional[GrantaServerApiDataExportDatumsBinaryData]" = None, meta_datums: "Optional[List[GrantaServerApiDataExportDatumsDatum]]" = None, not_applicable: "Optional[bool]" = None,) -> None:
