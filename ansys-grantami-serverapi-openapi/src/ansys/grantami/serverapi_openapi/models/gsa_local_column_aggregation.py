...
class GsaLocalColumnAggregation(ModelBase):
    ...
    def __init__(self, *, local_column_aggregation_type: "GsaLocalColumnAggregationType", count: "Union[int, Unset_Type]" = Unset, local_column_guid: "Union[str, None, Unset_Type]" = Unset, local_column_identity: "Union[int, None, Unset_Type]" = Unset,) -> None:
    ...
    def local_column_aggregation_type(self, local_column_aggregation_type: "GsaLocalColumnAggregationType") -> None:
