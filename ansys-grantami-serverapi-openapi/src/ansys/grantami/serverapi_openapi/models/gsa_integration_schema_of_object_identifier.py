...
class GsaIntegrationSchemaOfObjectIdentifier(ModelBase):
    ...
    def __init__(self, *, access_control_category_values: "Union[dict[str, list[str]], None, Unset_Type]" = Unset, attributes: "Union[list[GsaIntegrationAttribute], None, Unset_Type]" = Unset, discrete_types: "Union[list[GsaIntegrationDiscreteType], None, Unset_Type]" = Unset, key: "Union[str, None, Unset_Type]" = Unset, layouts: "Union[list[GsaIntegrationLayout], None, Unset_Type]" = Unset, security_groups: "Union[GsaSecurityGroups, Unset_Type]" = Unset, sources: "Union[list[GsaSourceOfObjectIdentifier], None, Unset_Type]" = Unset, unit_system: "Union[str, None, Unset_Type]" = Unset, version: "Union[int, None, Unset_Type]" = Unset,) -> None:
    ...
    @attributes.setter
    def attributes(self, attributes: "Union[list[GsaIntegrationAttribute], None, Unset_Type]") -> None:
    ...
    def discrete_types(self, discrete_types: "Union[list[GsaIntegrationDiscreteType], None, Unset_Type]") -> None:
    ...
    @sources.setter
    def sources(self, sources: "Union[list[GsaSourceOfObjectIdentifier], None, Unset_Type]") -> None:
