...
class GrantaServerApiSchemaDatabase(ModelBase):  # type: ignore[misc]
    ...
    @property
    def is_access_controlled(self) -> "Optional[bool]":
    ...
    def is_access_controlled(self, is_access_controlled: "Optional[bool]") -> None:
