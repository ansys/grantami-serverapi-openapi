...
class GrantaServerApiSearchRecordAncestorHistoryIdentitiesCriterion(
    ...
    @property
    def ancestor_history_identities(self) -> "list[int]":
    ...
    def ancestor_history_identities(
        self, ancestor_history_identities: "list[int]"
    ) -> None:
    ...
    def to_dict(self) -> Dict:
        ...
        for attr in self.swagger_types.keys():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(
            GrantaServerApiSearchRecordAncestorHistoryIdentitiesCriterion, dict
        ):
