...
from ansys.grantami.serverapi_openapi.models.granta_server_api_aggregations_attribute_aggregation_criterion import GrantaServerApiAggregationsAttributeAggregationCriterion  # noqa: F401
...
class GrantaServerApiAggregationsAttributeAggregationValueCriterion(GrantaServerApiAggregationsAttributeAggregationCriterion):
    ...
    def __init__(self, *, attribute_aggregation_criterion_type: "str" = 'value', guid: "Optional[str]" = None, identity: "Optional[int]" = None, inner_criterion: "Optional[GrantaServerApiAggregationsAggregationDatumCriterion]" = None, is_meta_attribute: "Optional[bool]" = None, type: "str" = 'attribute',) -> None:
    ...
    @property
    def inner_criterion(self) -> "GrantaServerApiAggregationsAggregationDatumCriterion":
    ...
    def inner_criterion(self, inner_criterion: "GrantaServerApiAggregationsAggregationDatumCriterion") -> None:
