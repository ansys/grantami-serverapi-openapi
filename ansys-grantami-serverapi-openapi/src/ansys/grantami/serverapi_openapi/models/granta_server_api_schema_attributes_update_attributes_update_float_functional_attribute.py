...
class GrantaServerApiSchemaAttributesUpdateAttributesUpdateFloatFunctionalAttribute(GrantaServerApiSchemaAttributesUpdateAttributesUpdateAttribute):
    ...
    def __init__(self, *, about_attribute: "Optional[GrantaServerApiSchemaSlimEntitiesSlimNamedEntity]" = None, attribute_parameters: "Optional[List[GrantaServerApiSchemaAttributesUpdateFloatFunctionalAttributeParameter]]" = None, axis_name: "Optional[str]" = None, default_threshold_type: "Optional[GrantaServerApiSchemaAttributesAttributeThresholdType]" = None, guid: "Optional[str]" = None, help_path: "Optional[str]" = None, is_range: "Optional[bool]" = None, name: "Optional[str]" = None, type: "str" = 'floatFunctional', unit: "Optional[GrantaServerApiSchemaSlimEntitiesSlimUnit]" = None,) -> None:
        ...
        ----------
            ...
            attribute_parameters: List[GrantaServerApiSchemaAttributesUpdateFloatFunctionalAttributeParameter], optional
    ...
    @property
    def attribute_parameters(self) -> "list[GrantaServerApiSchemaAttributesUpdateFloatFunctionalAttributeParameter]":
        """Gets the attribute_parameters of this GrantaServerApiSchemaAttributesUpdateAttributesUpdateFloatFunctionalAttribute.

        Returns
        -------
        list[GrantaServerApiSchemaAttributesUpdateFloatFunctionalAttributeParameter]
    ...
    def attribute_parameters(self, attribute_parameters: "list[GrantaServerApiSchemaAttributesUpdateFloatFunctionalAttributeParameter]") -> None:
