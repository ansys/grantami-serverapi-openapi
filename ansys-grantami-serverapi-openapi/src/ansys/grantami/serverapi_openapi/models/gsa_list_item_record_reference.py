...
class GsaListItemRecordReference(ModelBase):
    ...
    def __init__(self, *, database_guid: "Union[str, Unset_Type]" = Unset, record_history_guid: "Union[str, Unset_Type]" = Unset, record_version: "Union[int, None, Unset_Type]" = Unset,) -> None:
