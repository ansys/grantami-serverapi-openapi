...
class GsaEnabledLicensesInfo(ModelBase):
    ...
    def __init__(self, *, is_flex_licensing_enabled: "bool", mi_server_enabled: "bool", ml_enabled: "bool", plm_sync_enabled: "bool", restricted_substances_ba_enabled: "bool", sustainability_enabled_enabled: "bool", workflow_advanced_enabled: "bool", expiry_date: "Union[datetime, None, Unset_Type]" = Unset,) -> None:
    ...
    def restricted_substances_ba_enabled(self, restricted_substances_ba_enabled: "bool") -> None:
        ...
        if restricted_substances_ba_enabled is None:
            raise ValueError("Invalid value for 'restricted_substances_ba_enabled', must not be 'None'")
        # Field is required
        if restricted_substances_ba_enabled is Unset:  # type: ignore[comparison-overlap, unused-ignore]
            raise ValueError("Invalid value for 'restricted_substances_ba_enabled', must not be 'Unset'")
    ...
    def sustainability_enabled_enabled(self, sustainability_enabled_enabled: "bool") -> None:
        ...
        if sustainability_enabled_enabled is None:
            raise ValueError("Invalid value for 'sustainability_enabled_enabled', must not be 'None'")
        # Field is required
        if sustainability_enabled_enabled is Unset:  # type: ignore[comparison-overlap, unused-ignore]
            raise ValueError("Invalid value for 'sustainability_enabled_enabled', must not be 'Unset'")
