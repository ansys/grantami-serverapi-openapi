...
class GrantaServerApiListsDtoRecordListHeader(ModelBase):
    ...
    def parent_record_list_identifier(self, parent_record_list_identifier: "str") -> None:
    ...
    def published_user(self, published_user: "GrantaServerApiListsDtoUserOrGroup") -> None:
