...
class GsaRecordHistory(ModelBase):
    ...
    def __init__(self, *, guid: "str", is_folder: "bool", record_versions: "list[GsaSlimRecordVersion]", subsets: "list[GsaSlimSubset]", table: "GsaSlimTable", parent: "Union[GsaSlimRecordHistory, Unset_Type]" = Unset,) -> None:
