...
class GrantaServerApiFunctionalDatumParameterInfo(ModelBase):
    ...
    @property
    def scale_type_defined_at(self) -> "GrantaServerApiDataExportParameterSettingDefinedAt":
    ...
    def scale_type_defined_at(self, scale_type_defined_at: "GrantaServerApiDataExportParameterSettingDefinedAt") -> None:
    ...
    @property
    def interpolation_method_defined_at(self) -> "GrantaServerApiDataExportParameterSettingDefinedAt":
    ...
    def interpolation_method_defined_at(self, interpolation_method_defined_at: "GrantaServerApiDataExportParameterSettingDefinedAt") -> None:
    ...
    @property
    def default_value_defined_at(self) -> "GrantaServerApiDataExportParameterSettingDefinedAt":
    ...
    def default_value_defined_at(self, default_value_defined_at: "GrantaServerApiDataExportParameterSettingDefinedAt") -> None:
