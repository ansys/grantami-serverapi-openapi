...
class GsaParameterConstraint(ModelBase):
    ...
    discriminator_value_class_map = {
        "discreteName".lower(): "#/components/schemas/GsaDiscreteParameterNameConstraint",
        "discreteValue".lower(): "#/components/schemas/GsaDiscreteParameterValueConstraint",
        "numeric".lower(): "#/components/schemas/GsaNumericParameterConstraint",
    }

    discriminator: Optional[str] = "type"

    def __init__(self, *, parameter: "GsaObjectIdentifier", type: "GsaParameterConstraintType",) -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaParameterConstraint):
            return False
