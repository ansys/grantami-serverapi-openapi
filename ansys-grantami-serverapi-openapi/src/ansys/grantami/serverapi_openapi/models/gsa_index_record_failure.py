...
class GsaIndexRecordFailure(ModelBase):
    ...
    def __init__(self, *, error: "Union[str, None, Unset_Type]" = Unset, record_history_identity: "Union[int, Unset_Type]" = Unset, record_name: "Union[str, None, Unset_Type]" = Unset, record_was_oversized: "Union[bool, Unset_Type]" = Unset,) -> None:
