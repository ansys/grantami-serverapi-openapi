...
class GsaTabularAttributeTarget(ModelBase):
    ...
    def __init__(self, *, target_attribute_guid: "Union[str, Unset_Type]" = Unset, target_database_guid: "Union[str, Unset_Type]" = Unset, target_database_version_guid: "Union[str, Unset_Type]" = Unset, target_table_guid: "Union[str, Unset_Type]" = Unset,) -> None:
    ...
    def target_database_version_guid(self, target_database_version_guid: "Union[str, Unset_Type]") -> None:
