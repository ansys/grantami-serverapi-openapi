...
class GsaLinkedRecordExportBehavior(ModelBase):
    ...
    def __init__(self, *, linked_records_criterion: "Union[GsaCriterion, Unset_Type]" = Unset, summary_roll_up_type: "Union[GsaTabularColumnRollUpType, Unset_Type]" = Unset, tabular_row_behavior: "Union[GsaTabularRowExportBehavior, Unset_Type]" = Unset,) -> None:
    ...
    def tabular_row_behavior(self, tabular_row_behavior: "Union[GsaTabularRowExportBehavior, Unset_Type]") -> None:
    ...
    def linked_records_criterion(self, linked_records_criterion: "Union[GsaCriterion, Unset_Type]") -> None:
