...
class GrantaServerApiSchemaLayoutsNewLayoutAttributeItem(GrantaServerApiSchemaLayoutsNewLayoutItem):
    ...
    @property
    def meta_attributes(self) -> "list[GrantaServerApiSchemaLayoutsNewLayoutAttributeItem]":
    ...
    def meta_attributes(self, meta_attributes: "list[GrantaServerApiSchemaLayoutsNewLayoutAttributeItem]") -> None:
