...
class GrantaServerApiAggregationsAttributeAggregationExistsCriterion(GrantaServerApiAggregationsAttributeAggregationCriterion):
    ...
    @property
    def inner_criterion(self) -> "GrantaServerApiAggregationsAggregationDatumExistsCriterion":
    ...
    def inner_criterion(self, inner_criterion: "GrantaServerApiAggregationsAggregationDatumExistsCriterion") -> None:
