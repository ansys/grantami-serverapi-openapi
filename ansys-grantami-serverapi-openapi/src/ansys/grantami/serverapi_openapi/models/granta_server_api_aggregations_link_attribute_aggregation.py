...
class GrantaServerApiAggregationsLinkAttributeAggregation(GrantaServerApiAggregationsAttributeValueAggregation):
    ...
    def __init__(self, *, attribute_aggregation_type: "str" = 'value', attribute_guid: "Optional[str]" = None, attribute_identity: "Optional[int]" = None, count: "Optional[int]" = None, datum_type: "str" = 'link', local_aggregations: "Optional[List[GrantaServerApiAggregationsAttributeAggregation]]" = None, type: "str" = 'attribute') -> None:
        ...
        ----------
            ...
            count: int, optional
            datum_type: str
            local_aggregations: List[GrantaServerApiAggregationsAttributeAggregation], optional
            type: str
        """
    ...
    @property
    def local_aggregations(self) -> "list[GrantaServerApiAggregationsAttributeAggregation]":
        """Gets the local_aggregations of this GrantaServerApiAggregationsLinkAttributeAggregation.

        Returns
        -------
        list[GrantaServerApiAggregationsAttributeAggregation]
            The local_aggregations of this GrantaServerApiAggregationsLinkAttributeAggregation.
        """
        return self._local_aggregations

    @local_aggregations.setter
    def local_aggregations(self, local_aggregations: "list[GrantaServerApiAggregationsAttributeAggregation]") -> None:
    ...
    def datum_type(self) -> "str":
        """Gets the datum_type of this GrantaServerApiAggregationsLinkAttributeAggregation.

        Returns
        -------
        str
            The datum_type of this GrantaServerApiAggregationsLinkAttributeAggregation.
        """
