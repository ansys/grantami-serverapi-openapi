...
class GsaCreateTabularColumn(ModelBase):
    ...
    def summary_row_roll_up_type(self, summary_row_roll_up_type: "Union[GsaTabularColumnRollUpType, Unset_Type]") -> None:
