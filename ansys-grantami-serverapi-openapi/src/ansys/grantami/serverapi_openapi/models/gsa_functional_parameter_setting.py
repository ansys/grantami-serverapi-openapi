...
class GsaFunctionalParameterSetting(ModelBase):
    ...
    def __init__(self, *, default_value: "GsaParameterDataValue", interpolation_type: "GsaParameterInterpolationType", parameter: "GsaSlimParameter", scale_type: "GsaParameterScaleType",) -> None:
