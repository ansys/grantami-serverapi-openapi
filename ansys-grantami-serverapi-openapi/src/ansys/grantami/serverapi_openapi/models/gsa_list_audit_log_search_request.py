...
class GsaListAuditLogSearchRequest(ModelBase):
    ...
    def __init__(self, *, list_actions_to_include: "Union[list[GsaListAction], None, Unset_Type]" = Unset, list_identifiers: "Union[list[str], None, Unset_Type]" = Unset, paging_options: "Union[GsaListsPagingOptions, Unset_Type]" = Unset,) -> None:
    ...
    def list_actions_to_include(self, list_actions_to_include: "Union[list[GsaListAction], None, Unset_Type]") -> None:
