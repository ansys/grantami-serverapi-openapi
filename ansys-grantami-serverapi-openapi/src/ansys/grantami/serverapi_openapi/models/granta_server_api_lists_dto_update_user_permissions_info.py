...
class GrantaServerApiListsDtoUpdateUserPermissionsInfo(ModelBase):  # type: ignore[misc]
    ...
    def __init__(
        ...
        *,
        ...
        ----------
            user_permissions: List[GrantaServerApiListsDtoUpdateUserPermission]
        """
        self._user_permissions: List[GrantaServerApiListsDtoUpdateUserPermission] = None  # type: ignore[assignment]
