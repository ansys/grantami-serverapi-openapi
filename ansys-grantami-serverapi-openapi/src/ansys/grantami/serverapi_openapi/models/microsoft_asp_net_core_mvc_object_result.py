...
class MicrosoftAspNetCoreMvcObjectResult(ModelBase):
    ...
    def __init__(self, *, content_types: "Union[list[str], None, Unset_Type]" = Unset, declared_type: "Union[str, None, Unset_Type]" = Unset, formatters: "Union[list[MicrosoftAspNetCoreMvcFormattersIOutputFormatter], None, Unset_Type]" = Unset, status_code: "Union[int, None, Unset_Type]" = Unset, value: "Union[object, None, Unset_Type]" = Unset,) -> None:
        ...
        self._formatters: Union[list[MicrosoftAspNetCoreMvcFormattersIOutputFormatter], None, Unset_Type] = Unset
    ...
    @property
    def formatters(self) -> "Union[list[MicrosoftAspNetCoreMvcFormattersIOutputFormatter], None, Unset_Type]":
    ...
    @formatters.setter
    def formatters(self, formatters: "Union[list[MicrosoftAspNetCoreMvcFormattersIOutputFormatter], None, Unset_Type]") -> None:
