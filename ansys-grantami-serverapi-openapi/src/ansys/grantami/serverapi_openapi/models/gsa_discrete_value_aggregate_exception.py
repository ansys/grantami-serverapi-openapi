...
class GsaDiscreteValueAggregateException(ModelBase):
    ...
    def __init__(self, *, reason: "GsaDiscreteValueAggregateErrorReason", code: "Union[SystemNetHttpStatusCode, Unset_Type]" = Unset, errors: "Union[list[GsaErrorDetail], None, Unset_Type]" = Unset, message: "Union[str, None, Unset_Type]" = Unset,) -> None:
