...
class GsaCreateFloatFunctionalAttributeParameter(ModelBase):
    ...
    discriminator_value_class_map = {
        "discrete".lower(): "#/components/schemas/GsaCreateFloatFunctionalAttributeDiscreteParameter",
        "numeric".lower(): "#/components/schemas/GsaCreateFloatFunctionalAttributeNumericParameter",
    }
    ...
    def parameter(self) -> "GsaSlimEntity":
        """Gets the parameter of this GsaCreateFloatFunctionalAttributeParameter.

        Returns
        -------
        GsaSlimEntity
            The parameter of this GsaCreateFloatFunctionalAttributeParameter.
        """
        return self._parameter

    @parameter.setter
    def parameter(self, parameter: "GsaSlimEntity") -> None:
        """Sets the parameter of this GsaCreateFloatFunctionalAttributeParameter.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaCreateFloatFunctionalAttributeParameter):
            return False
