...
class GsaCreateTable(ModelBase):
    ...
    def __init__(self, *, name: "str", guid: "Union[str, Unset_Type]" = Unset, is_hidden_from_browse: "Union[bool, Unset_Type]" = Unset, is_hidden_from_search: "Union[bool, Unset_Type]" = Unset,) -> None:
