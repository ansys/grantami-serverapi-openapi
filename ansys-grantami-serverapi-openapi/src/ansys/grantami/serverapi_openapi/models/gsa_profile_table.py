...
class GsaProfileTable(ModelBase):
    ...
    def __init__(self, *, database_guid: "str", table_guid: "str", database_fallback_hint: "Union[str, None, Unset_Type]" = Unset, guid: "Union[str, None, Unset_Type]" = Unset, layout_fallback_hint: "Union[str, None, Unset_Type]" = Unset, layout_guid: "Union[str, None, Unset_Type]" = Unset, subset_fallback_hint: "Union[str, None, Unset_Type]" = Unset, subset_guid: "Union[str, None, Unset_Type]" = Unset, table_fallback_hint: "Union[str, None, Unset_Type]" = Unset,) -> None:
