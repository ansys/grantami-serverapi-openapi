...
class GsaReleaseTableVersionControlException(ModelBase):
    ...
    def message(self) -> "Union[str, None, Unset_Type]":
        """Gets the message of this GsaReleaseTableVersionControlException.

        Returns
        -------
        Union[str, None, Unset_Type]
            The message of this GsaReleaseTableVersionControlException.
        """
        return self._message

    @message.setter
    def message(self, message: "Union[str, None, Unset_Type]") -> None:
        """Sets the message of this GsaReleaseTableVersionControlException.
    ...
    def code(self) -> "Union[SystemNetHttpStatusCode, Unset_Type]":
        """Gets the code of this GsaReleaseTableVersionControlException.

        Returns
        -------
        Union[SystemNetHttpStatusCode, Unset_Type]
            The code of this GsaReleaseTableVersionControlException.
        """
        return self._code

    @code.setter
    def code(self, code: "Union[SystemNetHttpStatusCode, Unset_Type]") -> None:
        """Sets the code of this GsaReleaseTableVersionControlException.
    ...
    def errors(self) -> "Union[list[GsaVersionControlErrorDetail], None, Unset_Type]":
        """Gets the errors of this GsaReleaseTableVersionControlException.

        Returns
        -------
        Union[list[GsaVersionControlErrorDetail], None, Unset_Type]
            The errors of this GsaReleaseTableVersionControlException.
        """
        return self._errors

    @errors.setter
    def errors(self, errors: "Union[list[GsaVersionControlErrorDetail], None, Unset_Type]") -> None:
        """Sets the errors of this GsaReleaseTableVersionControlException.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaReleaseTableVersionControlException):
            return False
