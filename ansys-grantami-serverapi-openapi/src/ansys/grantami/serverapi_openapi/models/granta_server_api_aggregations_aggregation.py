...
class GrantaServerApiAggregationsAggregation(ModelBase):
    ...
    discriminator_value_class_map = {
        'attribute'.lower(): '#/components/schemas/GrantaServerApiAggregationsAttributeAggregation',
        'text'.lower(): '#/components/schemas/GrantaServerApiAggregationsFreeTextAggregation',
    }

    def __init__(self):  # noqa: E501
        """GrantaServerApiAggregationsAggregation - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr in self.swagger_types.keys():
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GrantaServerApiAggregationsAggregation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GrantaServerApiAggregationsAggregation):
            return False
