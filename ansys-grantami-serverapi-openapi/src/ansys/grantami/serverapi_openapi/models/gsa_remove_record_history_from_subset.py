...
class GsaRemoveRecordHistoryFromSubset(ModelBase):
    ...
    def __init__(self, *, record_history_guid: "str",) -> None:
        """GsaRemoveRecordHistoryFromSubset - a model defined in Swagger
    ...
    def record_history_guid(self) -> "str":
        """Gets the record_history_guid of this GsaRemoveRecordHistoryFromSubset.

        Returns
        -------
        str
            The record_history_guid of this GsaRemoveRecordHistoryFromSubset.
        """
        return self._record_history_guid

    @record_history_guid.setter
    def record_history_guid(self, record_history_guid: "str") -> None:
        """Sets the record_history_guid of this GsaRemoveRecordHistoryFromSubset.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaRemoveRecordHistoryFromSubset):
            return False
