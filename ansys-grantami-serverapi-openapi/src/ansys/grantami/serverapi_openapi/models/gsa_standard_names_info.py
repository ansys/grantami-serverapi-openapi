...
class GsaStandardNamesInfo(ModelBase):
    ...
    def __init__(self, *, standard_names: "Union[list[GsaStandardName], None, Unset_Type]" = Unset,) -> None:
    ...
    def standard_names(self, standard_names: "Union[list[GsaStandardName], None, Unset_Type]") -> None:
