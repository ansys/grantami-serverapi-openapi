...
class GrantaServerApiDataExportDatumsDiscreteFunctionalDatum(GrantaServerApiDataExportDatumsApplicableDatum):
    ...
    def __init__(self, *, attribute_guid: "Optional[str]" = None, attribute_identity: "Optional[int]" = None, datum_type: "str" = 'discreteFunctional', meta_datums: "Optional[List[GrantaServerApiDataExportDatumsDatum]]" = None, not_applicable: "Optional[bool]" = None, parameters: "Optional[List[GrantaServerApiFunctionalDatumParameterInfo]]" = None, x_axis_parameter: "Optional[GrantaServerApiFunctionalDatumParameterInfo]" = None,) -> None:
    ...
    def x_axis_parameter(self, x_axis_parameter: "GrantaServerApiFunctionalDatumParameterInfo") -> None:
    ...
    @parameters.setter
    def parameters(self, parameters: "list[GrantaServerApiFunctionalDatumParameterInfo]") -> None:
