...
class GsaSlimObjects(ModelBase):
    ...
    def __init__(self, *, attributes: "Union[list[GsaSlimAttribute], None, Unset_Type]" = Unset,) -> None:
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaSlimObjects):
            return False
