...
class GsaRecordListHeader(ModelBase):
    ...
    swagger_types: dict[str, str] = {
        ...
        "created_user": "GsaListsUserOrGroup",
        "identifier": "str",
        "internal_use": "bool",
        "is_revision": "bool",
        "last_modified_timestamp": "datetime",
        "last_modified_user": "GsaListsUserOrGroup",
        ...
        "published_user": "GsaListsUserOrGroup",
    }
    ...
    subtype_mapping: dict[str, str] = {
        "createdUser": "GsaListsUserOrGroup",
        "lastModifiedUser": "GsaListsUserOrGroup",
        "publishedUser": "GsaListsUserOrGroup",
    }

    discriminator: Optional[str] = None

    def __init__(self, *, awaiting_approval: "bool", created_timestamp: "datetime", created_user: "GsaListsUserOrGroup", identifier: "str", internal_use: "bool", is_revision: "bool", last_modified_timestamp: "datetime", last_modified_user: "GsaListsUserOrGroup", metadata: "dict[str, dict[str, object]]", name: "str", published: "bool", description: "Union[str, None, Unset_Type]" = Unset, notes: "Union[str, None, Unset_Type]" = Unset, parent_record_list_identifier: "Union[str, None, Unset_Type]" = Unset, published_timestamp: "Union[datetime, None, Unset_Type]" = Unset, published_user: "Union[GsaListsUserOrGroup, Unset_Type]" = Unset,) -> None:
        """GsaRecordListHeader - a model defined in Swagger
    ...
    def identifier(self) -> "str":
        """Gets the identifier of this GsaRecordListHeader.

        Returns
        -------
        str
            The identifier of this GsaRecordListHeader.
        """
        return self._identifier

    @identifier.setter
    def identifier(self, identifier: "str") -> None:
        """Sets the identifier of this GsaRecordListHeader.
    ...
    def metadata(self) -> "dict[str, dict[str, object]]":
        """Gets the metadata of this GsaRecordListHeader.

        Returns
        -------
        dict[str, dict[str, object]]
            The metadata of this GsaRecordListHeader.
        """
        return self._metadata

    @metadata.setter
    def metadata(self, metadata: "dict[str, dict[str, object]]") -> None:
        """Sets the metadata of this GsaRecordListHeader.
    ...
    def parent_record_list_identifier(self) -> "Union[str, None, Unset_Type]":
        """Gets the parent_record_list_identifier of this GsaRecordListHeader.

        Returns
        -------
        Union[str, None, Unset_Type]
            The parent_record_list_identifier of this GsaRecordListHeader.
        """
        return self._parent_record_list_identifier

    @parent_record_list_identifier.setter
    def parent_record_list_identifier(self, parent_record_list_identifier: "Union[str, None, Unset_Type]") -> None:
        """Sets the parent_record_list_identifier of this GsaRecordListHeader.
    ...
    def created_timestamp(self) -> "datetime":
        """Gets the created_timestamp of this GsaRecordListHeader.

        Returns
        -------
        datetime
            The created_timestamp of this GsaRecordListHeader.
        """
        return self._created_timestamp

    @created_timestamp.setter
    def created_timestamp(self, created_timestamp: "datetime") -> None:
        """Sets the created_timestamp of this GsaRecordListHeader.
    ...
    @property
    def created_user(self) -> "GsaListsUserOrGroup":
        """Gets the created_user of this GsaRecordListHeader.

        Returns
        -------
        GsaListsUserOrGroup
            The created_user of this GsaRecordListHeader.
        """
        return self._created_user

    @created_user.setter
    def created_user(self, created_user: "GsaListsUserOrGroup") -> None:
        """Sets the created_user of this GsaRecordListHeader.
    ...
    def last_modified_timestamp(self) -> "datetime":
        """Gets the last_modified_timestamp of this GsaRecordListHeader.

        Returns
        -------
        datetime
            The last_modified_timestamp of this GsaRecordListHeader.
        """
        return self._last_modified_timestamp

    @last_modified_timestamp.setter
    def last_modified_timestamp(self, last_modified_timestamp: "datetime") -> None:
        """Sets the last_modified_timestamp of this GsaRecordListHeader.
    ...
    @property
    def last_modified_user(self) -> "GsaListsUserOrGroup":
        """Gets the last_modified_user of this GsaRecordListHeader.

        Returns
        -------
        GsaListsUserOrGroup
            The last_modified_user of this GsaRecordListHeader.
        """
        return self._last_modified_user

    @last_modified_user.setter
    def last_modified_user(self, last_modified_user: "GsaListsUserOrGroup") -> None:
        """Sets the last_modified_user of this GsaRecordListHeader.
    ...
    def published_timestamp(self) -> "Union[datetime, None, Unset_Type]":
        """Gets the published_timestamp of this GsaRecordListHeader.

        Returns
        -------
        Union[datetime, None, Unset_Type]
            The published_timestamp of this GsaRecordListHeader.
        """
    ...
    def published_timestamp(self, published_timestamp: "Union[datetime, None, Unset_Type]") -> None:
        """Sets the published_timestamp of this GsaRecordListHeader.
    ...
    @property
    def published_user(self) -> "Union[GsaListsUserOrGroup, Unset_Type]":
        """Gets the published_user of this GsaRecordListHeader.

        Returns
        -------
        Union[GsaListsUserOrGroup, Unset_Type]
            The published_user of this GsaRecordListHeader.
        """
        return self._published_user

    @published_user.setter
    def published_user(self, published_user: "Union[GsaListsUserOrGroup, Unset_Type]") -> None:
        """Sets the published_user of this GsaRecordListHeader.

        Parameters
        ----------
        published_user: Union[GsaListsUserOrGroup, Unset_Type]
            The published_user of this GsaRecordListHeader.
        """
        # Field is not nullable
    ...
    def is_revision(self) -> "bool":
        """Gets the is_revision of this GsaRecordListHeader.

        Returns
        -------
        bool
            The is_revision of this GsaRecordListHeader.
        """
        return self._is_revision

    @is_revision.setter
    def is_revision(self, is_revision: "bool") -> None:
        """Sets the is_revision of this GsaRecordListHeader.
    ...
    @property
    def name(self) -> "str":
        """Gets the name of this GsaRecordListHeader.

        Returns
        -------
        str
            The name of this GsaRecordListHeader.
        """
        return self._name

    @name.setter
    def name(self, name: "str") -> None:
        """Sets the name of this GsaRecordListHeader.
    ...
    def description(self) -> "Union[str, None, Unset_Type]":
        """Gets the description of this GsaRecordListHeader.

        Returns
        -------
        Union[str, None, Unset_Type]
            The description of this GsaRecordListHeader.
        """
        return self._description

    @description.setter
    def description(self, description: "Union[str, None, Unset_Type]") -> None:
        """Sets the description of this GsaRecordListHeader.
    ...
    def notes(self) -> "Union[str, None, Unset_Type]":
        """Gets the notes of this GsaRecordListHeader.

        Returns
        -------
        Union[str, None, Unset_Type]
            The notes of this GsaRecordListHeader.
        """
        return self._notes

    @notes.setter
    def notes(self, notes: "Union[str, None, Unset_Type]") -> None:
        """Sets the notes of this GsaRecordListHeader.
    ...
    def published(self) -> "bool":
        """Gets the published of this GsaRecordListHeader.

        Returns
        -------
        bool
            The published of this GsaRecordListHeader.
        """
        return self._published

    @published.setter
    def published(self, published: "bool") -> None:
        """Sets the published of this GsaRecordListHeader.
    ...
    def awaiting_approval(self) -> "bool":
        """Gets the awaiting_approval of this GsaRecordListHeader.

        Returns
        -------
        bool
            The awaiting_approval of this GsaRecordListHeader.
        """
        return self._awaiting_approval

    @awaiting_approval.setter
    def awaiting_approval(self, awaiting_approval: "bool") -> None:
        """Sets the awaiting_approval of this GsaRecordListHeader.
    ...
    def internal_use(self) -> "bool":
        """Gets the internal_use of this GsaRecordListHeader.

        Returns
        -------
        bool
            The internal_use of this GsaRecordListHeader.
        """
        return self._internal_use

    @internal_use.setter
    def internal_use(self, internal_use: "bool") -> None:
        """Sets the internal_use of this GsaRecordListHeader.
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        if not isinstance(other, GsaRecordListHeader):
            return False
