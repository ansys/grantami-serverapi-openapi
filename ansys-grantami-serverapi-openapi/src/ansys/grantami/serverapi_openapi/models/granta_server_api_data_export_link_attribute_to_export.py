...
class GrantaServerApiDataExportLinkAttributeToExport(GrantaServerApiDataExportAttributeToExport):
    ...
    @local_data.setter
    def local_data(self, local_data: "list[GrantaServerApiDataExportSimpleAttributeToExport]") -> None:
    ...
    def record_properties(self, record_properties: "list[GrantaServerApiRecordProperty]") -> None:
    ...
    @attributes.setter
    def attributes(self, attributes: "list[GrantaServerApiDataExportAttributeToExport]") -> None:
