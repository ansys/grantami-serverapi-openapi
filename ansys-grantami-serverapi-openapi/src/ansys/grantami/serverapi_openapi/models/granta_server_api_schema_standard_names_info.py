...
class GrantaServerApiSchemaStandardNamesInfo(ModelBase):
    ...
    def __init__(
        self,
        *,
        standard_names: "Optional[List[GrantaServerApiSchemaStandardName]]" = None,
    ) -> None:
        """GrantaServerApiSchemaStandardNamesInfo - a model defined in Swagger

        Parameters
        ----------
            standard_names: List[GrantaServerApiSchemaStandardName], optional
        """
    ...
    @property
    def standard_names(self) -> "list[GrantaServerApiSchemaStandardName]":
        """Gets the standard_names of this GrantaServerApiSchemaStandardNamesInfo.

        Returns
        -------
        list[GrantaServerApiSchemaStandardName]
            The standard_names of this GrantaServerApiSchemaStandardNamesInfo.
        """
        return self._standard_names

    @standard_names.setter
    def standard_names(
        self, standard_names: "list[GrantaServerApiSchemaStandardName]"
    ) -> None:
