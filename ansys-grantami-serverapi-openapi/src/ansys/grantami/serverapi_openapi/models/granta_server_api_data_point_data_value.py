...
class GrantaServerApiDataPointDataValue(ModelBase):  # type: ignore[misc]
    ...
    def __init__(
        ...
        *,
        parameter_and_values: "List[GrantaServerApiDataParameterWithValue]",
        point_value: "float",
        significant_figures_info: "Optional[GrantaServerApiDataSignificantFiguresInfo]" = None,
        ...
        """
        self._point_value: float = None  # type: ignore[assignment]
        self._unit = None
        self._significant_figures_info = None
        self._parameter_and_values: List[GrantaServerApiDataParameterWithValue] = None  # type: ignore[assignment]

        self.point_value = point_value
        if unit is not None:
            self.unit = unit
        if significant_figures_info is not None:
    ...
    def significant_figures_info(
        self,
        significant_figures_info: "Optional[GrantaServerApiDataSignificantFiguresInfo]",
    ) -> None:
