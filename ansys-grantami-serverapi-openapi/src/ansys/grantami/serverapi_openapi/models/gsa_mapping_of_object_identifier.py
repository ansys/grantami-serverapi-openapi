...
class GsaMappingOfObjectIdentifier(ModelBase):
    ...
    def __init__(self, *, link_source_type: "Union[GsaLinkSourceType, Unset_Type]" = Unset, parameter_mappings: "Union[list[GsaMappingOfObjectIdentifier], None, Unset_Type]" = Unset, source: "Union[GsaObjectIdentifier, Unset_Type]" = Unset, target_guid: "Union[str, Unset_Type]" = Unset, target_identity: "Union[int, Unset_Type]" = Unset,) -> None:
        ...
        self._parameter_mappings: Union[list[GsaMappingOfObjectIdentifier], None, Unset_Type] = Unset
    ...
    def parameter_mappings(self, parameter_mappings: "Union[list[GsaMappingOfObjectIdentifier], None, Unset_Type]") -> None:
