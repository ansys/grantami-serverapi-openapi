...
class GrantaServerApiSchemaConfigurationsConfigurationsInfo(ModelBase):
    ...
    def __init__(self, *, configurations: "Optional[List[GrantaServerApiSchemaSlimEntitiesSlimConfiguration]]" = None) -> None:
    ...
    def configurations(self, configurations: "list[GrantaServerApiSchemaSlimEntitiesSlimConfiguration]") -> None:
