...
class GsaIntegrationDiscreteType(ModelBase):
    ...
    def __init__(self, *, guid: "Union[str, Unset_Type]" = Unset, identity: "Union[int, Unset_Type]" = Unset, name: "Union[str, None, Unset_Type]" = Unset, values: "Union[list[str], None, Unset_Type]" = Unset,) -> None:
