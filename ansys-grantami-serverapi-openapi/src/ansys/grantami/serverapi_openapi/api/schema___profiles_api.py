...
class SchemaProfilesApi(ApiBase):
    ...
    def create_profile(self, *, body: "Optional[GsaCreateProfile]" = None) -> "Union[GsaProfile, None]":
    ...
    def _create_profile_with_http_info(self, body: "Optional[GsaCreateProfile]" = None, **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method create_profile")
            params[key] = val
        del params["kwargs"]
    ...
    def _delete_profile_with_http_info(self, profile_guid: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method delete_profile")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "profile_guid" is set
        if "profile_guid" not in params or params["profile_guid"] is None:
            raise ValueError("Missing the required parameter 'profile_guid' when calling 'delete_profile'")
    ...
    def _get_profile_with_http_info(self, profile_guid: "str", **kwargs: Any) -> Any:
        ...
        # verify the required parameter "profile_guid" is set
        if "profile_guid" not in params or params["profile_guid"] is None:
            raise ValueError("Missing the required parameter 'profile_guid' when calling 'get_profile'")
    ...
    def _get_profiles_with_http_info(self, **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_profiles")
            params[key] = val
        del params["kwargs"]
    ...
    def update_all_profiles_info(self, *, body: "Optional[GsaUpdateAllProfilesInfo]" = None) -> "Union[GsaAllProfilesInfo, None]":
    ...
    def _update_all_profiles_info_with_http_info(self, body: "Optional[GsaUpdateAllProfilesInfo]" = None, **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method update_all_profiles_info")
            params[key] = val
        del params["kwargs"]
    ...
    def update_profile(self, *, profile_guid: "str", body: "Optional[GsaUpdateProfile]" = None) -> "Union[GsaProfile, None]":
        """Update a profile
    ...
    def _update_profile_with_http_info(self, profile_guid: "str", body: "Optional[GsaUpdateProfile]" = None, **kwargs: Any) -> Any:
        all_params = ["profile_guid", "body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method update_profile")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "profile_guid" is set
        if "profile_guid" not in params or params["profile_guid"] is None:
            raise ValueError("Missing the required parameter 'profile_guid' when calling 'update_profile'")
