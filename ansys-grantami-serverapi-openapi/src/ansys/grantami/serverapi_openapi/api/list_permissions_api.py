...
class ListPermissionsApi(ApiBase):
    ...
    def _get_permissions_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_permissions")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'get_permissions'")
    ...
    def get_permissions_for_user(self, *, list_identifier: "str", user_identifier: "str") -> "Union[GsaRecordListPermissionFlags, None]":
        ...
        """
        data = self._get_permissions_for_user_with_http_info(list_identifier, user_identifier, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _get_permissions_for_user_with_http_info(self, list_identifier: "str", user_identifier: "str", **kwargs: Any) -> Any:
        all_params = ["list_identifier", "user_identifier", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_permissions_for_user")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'get_permissions_for_user'")
        # verify the required parameter "user_identifier" is set
        if "user_identifier" not in params or params["user_identifier"] is None:
            raise ValueError("Missing the required parameter 'user_identifier' when calling 'get_permissions_for_user'")
    ...
    def set_permissions(self, *, list_identifier: "str", body: "Optional[GsaUpdateUserPermissionsInfo]" = None) -> "Union[GsaUserPermissionsInfo, None]":
        ...
        Union[GsaUserPermissionsInfo, None]
        """
        data = self._set_permissions_with_http_info(list_identifier, body, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _set_permissions_with_http_info(self, list_identifier: "str", body: "Optional[GsaUpdateUserPermissionsInfo]" = None, **kwargs: Any) -> Any:
        all_params = ["list_identifier", "body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method set_permissions")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'set_permissions'")
    ...
    def set_permissions_for_user(self, *, list_identifier: "str", user_identifier: "str", body: "Optional[GsaUpdateRecordListPermissionFlags]" = None) -> "Union[GsaRecordListPermissionFlags, None]":
        ...
        Union[GsaRecordListPermissionFlags, None]
        """
        data = self._set_permissions_for_user_with_http_info(list_identifier, user_identifier, body, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _set_permissions_for_user_with_http_info(self, list_identifier: "str", user_identifier: "str", body: "Optional[GsaUpdateRecordListPermissionFlags]" = None, **kwargs: Any) -> Any:
        all_params = ["list_identifier", "user_identifier", "body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method set_permissions_for_user")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'set_permissions_for_user'")
        # verify the required parameter "user_identifier" is set
        if "user_identifier" not in params or params["user_identifier"] is None:
            raise ValueError("Missing the required parameter 'user_identifier' when calling 'set_permissions_for_user'")
    ...
    def _subscribe_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'subscribe'")
    ...
    def _unsubscribe_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'unsubscribe'")
