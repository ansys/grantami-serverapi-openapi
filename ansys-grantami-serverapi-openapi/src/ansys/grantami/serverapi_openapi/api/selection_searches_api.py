...
class SelectionSearchesApi(ApiBase):
    ...
    def create_search(self, *, body: "Optional[GsaCreateSearchRequest]" = None) -> "Union[GsaSelectionSearch, None]":
    ...
    def _create_search_with_http_info(self, body: "Optional[GsaCreateSearchRequest]" = None, **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method create_search")
            params[key] = val
        del params["kwargs"]
        ...
        return self.api_client.call_api(
            "/v1alpha/selection-searches", "POST",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _delete_search_with_http_info(self, search_identifier: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method delete_search")
            params[key] = val
        del params["kwargs"]
        ...
        if "search_identifier" not in params or params["search_identifier"] is None:
            raise ValueError("Missing the required parameter 'search_identifier' when calling 'delete_search'")
        ...
        return self.api_client.call_api(
            "/v1alpha/selection-searches/search/{searchIdentifier}", "DELETE",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _get_all_with_http_info(self, **kwargs: Any) -> Any:
        ...
        return self.api_client.call_api(
            "/v1alpha/selection-searches", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _get_search_with_http_info(self, search_identifier: "str", **kwargs: Any) -> Any:
        ...
        # verify the required parameter "search_identifier" is set
        if "search_identifier" not in params or params["search_identifier"] is None:
            raise ValueError("Missing the required parameter 'search_identifier' when calling 'get_search'")
        ...
        return self.api_client.call_api(
            "/v1alpha/selection-searches/search/{searchIdentifier}", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def save_search(self, *, search_identifier: "str", body: "Optional[GsaSaveSearchRequest]" = None) -> "None":
        ...
        None
        """
        data = self._save_search_with_http_info(search_identifier, body, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _save_search_with_http_info(self, search_identifier: "str", body: "Optional[GsaSaveSearchRequest]" = None, **kwargs: Any) -> Any:
        ...
        # verify the required parameter "search_identifier" is set
        if "search_identifier" not in params or params["search_identifier"] is None:
            raise ValueError("Missing the required parameter 'search_identifier' when calling 'save_search'")
        ...
        return self.api_client.call_api(
            "/v1alpha/selection-searches/search/{searchIdentifier}", "PUT",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def search(self, *, body: "Optional[GsaFindSearchRequest]" = None) -> "Union[GsaSelectionSearch, None]":
    ...
    def _search_with_http_info(self, body: "Optional[GsaFindSearchRequest]" = None, **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]
        ...
        return self.api_client.call_api(
            "/v1alpha/selection-searches/search", "POST",
            path_params,
            query_params,
            header_params,
            body=body_params,
