...
class IntegrationApi(ApiBase):
    ...
    def add_schema(self, *, body: "Optional[GsaGuidOnlyIntegrationSchemaOfObjectIdentifier]" = None) -> "Union[GsaIntegrationSchemaOfObjectIdentifier, None]":
    ...
    def _add_schema_with_http_info(self, body: "Optional[GsaGuidOnlyIntegrationSchemaOfObjectIdentifier]" = None, **kwargs: Any) -> Any:
    ...
    def all_schema_status(self, *, include_errors: "Optional[bool]" = None) -> "Union[None, dict[str, GsaIntegrationSchemaStatus]]":
    ...
    def _all_schema_status_with_http_info(self, include_errors: "Optional[bool]" = None, **kwargs: Any) -> Any:
        all_params = ["include_errors", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method all_schema_status")
            params[key] = val
        del params["kwargs"]
    ...
    def _delete_schema_with_http_info(self, schema: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method delete_schema")
            params[key] = val
        del params["kwargs"]
    ...
    def get_schema(self, *, schema: "str", include_implicit_attributes: "Optional[bool]" = None) -> "Union[GsaIntegrationSchemaOfObjectIdentifier, None]":
        ...
        Union[GsaIntegrationSchemaOfObjectIdentifier, None]
        """
        data = self._get_schema_with_http_info(schema, include_implicit_attributes, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _get_schema_with_http_info(self, schema: "str", include_implicit_attributes: "Optional[bool]" = None, **kwargs: Any) -> Any:
    ...
    def get_status_for_integration_schema(self, *, schema: "str", include_errors: "Optional[bool]" = None) -> "Union[GsaIntegrationSchemaStatus, None]":
        ...
        """
        data = self._get_status_for_integration_schema_with_http_info(schema, include_errors, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _get_status_for_integration_schema_with_http_info(self, schema: "str", include_errors: "Optional[bool]" = None, **kwargs: Any) -> Any:
        all_params = ["schema", "include_errors", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_status_for_integration_schema")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "schema" is set
        if "schema" not in params or params["schema"] is None:
            raise ValueError("Missing the required parameter 'schema' when calling 'get_status_for_integration_schema'")
    ...
    def schema_table_mappings(self, *, schema: "str", database_key: "str", table_identity: "int") -> "Union[None, list[GsaSourceOfObjectIdentifier]]":
        ...
        """
        data = self._schema_table_mappings_with_http_info(schema, database_key, table_identity, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _schema_table_mappings_with_http_info(self, schema: "str", database_key: "str", table_identity: "int", **kwargs: Any) -> Any:
        all_params = ["schema", "database_key", "table_identity", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method schema_table_mappings")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "schema" is set
        if "schema" not in params or params["schema"] is None:
            raise ValueError("Missing the required parameter 'schema' when calling 'schema_table_mappings'")
        # verify the required parameter "database_key" is set
        if "database_key" not in params or params["database_key"] is None:
            raise ValueError("Missing the required parameter 'database_key' when calling 'schema_table_mappings'")
        # verify the required parameter "table_identity" is set
        if "table_identity" not in params or params["table_identity"] is None:
            raise ValueError("Missing the required parameter 'table_identity' when calling 'schema_table_mappings'")
    ...
    def schema_targets(self, *, schema: "str", include_implicit_attributes: "Optional[bool]" = None) -> "Union[None, list[GsaIntegrationAttribute]]":
        ...
        """
        data = self._schema_targets_with_http_info(schema, include_implicit_attributes, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _schema_targets_with_http_info(self, schema: "str", include_implicit_attributes: "Optional[bool]" = None, **kwargs: Any) -> Any:
        all_params = ["schema", "include_implicit_attributes", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method schema_targets")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "schema" is set
        if "schema" not in params or params["schema"] is None:
            raise ValueError("Missing the required parameter 'schema' when calling 'schema_targets'")
    ...
    def update_schema(self, *, schema: "str", body: "Optional[GsaGuidOnlyIntegrationSchemaOfObjectIdentifier]" = None) -> "Union[GsaIntegrationSchemaOfObjectIdentifier, None]":
    ...
    def _update_schema_with_http_info(self, schema: "str", body: "Optional[GsaGuidOnlyIntegrationSchemaOfObjectIdentifier]" = None, **kwargs: Any) -> Any:
        all_params = ["schema", "body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method update_schema")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "schema" is set
        if "schema" not in params or params["schema"] is None:
