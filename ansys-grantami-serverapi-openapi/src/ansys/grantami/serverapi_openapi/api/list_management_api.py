...
class ListManagementApi(ApiBase):
    ...
    def _copy_list_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'copy_list'")
    ...
    def create_list(self, *, body: "Optional[GsaCreateRecordList]" = None) -> "Union[GsaRecordListHeader, None]":
    ...
    def _create_list_with_http_info(self, body: "Optional[GsaCreateRecordList]" = None, **kwargs: Any) -> Any:
    ...
    def _delete_list_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'delete_list'")
    ...
    def _get_all_lists_with_http_info(self, **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_all_lists")
            params[key] = val
        del params["kwargs"]
    ...
    def _get_list_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'get_list'")
    ...
    def get_record_list_search_results(self, *, result_resource_identifier: "str") -> "Union[GsaRecordListSearchResultsInfo, None]":
        ...
        """
        data = self._get_record_list_search_results_with_http_info(result_resource_identifier, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _get_record_list_search_results_with_http_info(self, result_resource_identifier: "str", **kwargs: Any) -> Any:
        all_params = ["result_resource_identifier", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_record_list_search_results")
            params[key] = val
        del params["kwargs"]
        ...
        if "result_resource_identifier" not in params or params["result_resource_identifier"] is None:
            raise ValueError("Missing the required parameter 'result_resource_identifier' when calling 'get_record_list_search_results'")
    ...
    def _publish_list_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method publish_list")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'publish_list'")
    ...
    def _request_approval_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method request_approval")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'request_approval'")
    ...
    def reset_awaiting_approval(self, *, list_identifier: "str") -> "Union[GsaRecordListHeader, None]":
        ...
        Union[GsaRecordListHeader, None]
        """
        data = self._reset_awaiting_approval_with_http_info(list_identifier, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]
    ...
    def _reset_awaiting_approval_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method reset_awaiting_approval")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'reset_awaiting_approval'")
    ...
    def _revise_list_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'revise_list'")
    ...
    def run_record_lists_search(self, *, body: "Optional[GsaRecordListSearchRequest]" = None) -> "Union[GsaRecordListSearchInfo, None]":
    ...
    def _run_record_lists_search_with_http_info(self, body: "Optional[GsaRecordListSearchRequest]" = None, **kwargs: Any) -> Any:
        all_params = ["body", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method run_record_lists_search")
            params[key] = val
        del params["kwargs"]
    ...
    def _unpublish_list_with_http_info(self, list_identifier: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method unpublish_list")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'unpublish_list'")
    ...
    def update_list(self, *, list_identifier: "str", body: "Optional[GsaUpdateRecordListProperties]" = None) -> "Union[GsaRecordListHeader, None]":
    ...
    def _update_list_with_http_info(self, list_identifier: "str", body: "Optional[GsaUpdateRecordListProperties]" = None, **kwargs: Any) -> Any:
        ...
        # verify the required parameter "list_identifier" is set
        if "list_identifier" not in params or params["list_identifier"] is None:
            raise ValueError("Missing the required parameter 'list_identifier' when calling 'update_list'")
