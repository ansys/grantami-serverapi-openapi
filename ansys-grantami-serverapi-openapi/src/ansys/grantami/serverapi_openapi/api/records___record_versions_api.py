...
class RecordsRecordVersionsApi(ApiBase):  # type: ignore[misc]
    ...
    def create_record_version(
        ...
        *,
        ...
        Union[GrantaServerApiExceptionsVersionControlCreateRecordVersionControlException, GrantaServerApiRecordsRecordVersionsRecordVersion, None]
        """
        data = self._create_record_version_with_http_info(
            database_key,
            table_guid,
            record_history_guid,
            record_version_guid,
    ...
    def _create_record_version_with_http_info(
        self,
        database_key: "str",
        table_guid: "str",
        record_history_guid: "str",
        ...
        **kwargs: Any,
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method create_record_version"
                )
            params[key] = val
        del params["kwargs"]
        ...
        if "database_key" not in params or params["database_key"] is None:
            raise ValueError(
                "Missing the required parameter 'database_key' when calling 'create_record_version'"
            )
        # verify the required parameter "table_guid" is set
        if "table_guid" not in params or params["table_guid"] is None:
            raise ValueError(
                "Missing the required parameter 'table_guid' when calling 'create_record_version'"
            )
        ...
        if "record_history_guid" not in params or params["record_history_guid"] is None:
            raise ValueError(
                "Missing the required parameter 'record_history_guid' when calling 'create_record_version'"
            )
        ...
        if "record_version_guid" not in params or params["record_version_guid"] is None:
            raise ValueError(
                "Missing the required parameter 'record_version_guid' when calling 'create_record_version'"
            )
