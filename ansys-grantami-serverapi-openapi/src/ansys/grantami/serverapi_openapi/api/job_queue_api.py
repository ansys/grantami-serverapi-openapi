...
class JobQueueApi(ApiBase):
    ...
    def _create_job_with_http_info(self, body: "Optional[GsaCreateJobRequest]" = None, **kwargs: Any) -> Any:
    ...
    def _delete_job_with_http_info(self, id: "str", **kwargs: Any) -> Any:
        ...
        return self.api_client.call_api(
            "/v1alpha/job-queue/jobs/{id}", "DELETE",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _get_current_user_with_http_info(self, **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_current_user")
            params[key] = val
        del params["kwargs"]
        ...
        return self.api_client.call_api(
            "/v1alpha/job-queue/current-user", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _get_job_output_file_with_http_info(self, id: "str", file_name: "str", **kwargs: Any) -> Any:
        all_params = ["id", "file_name", "_return_http_data_only", "_preload_content", "_request_timeout"]

        params = locals()
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_job_output_file")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "id" is set
        if "id" not in params or params["id"] is None:
            raise ValueError("Missing the required parameter 'id' when calling 'get_job_output_file'")
        # verify the required parameter "file_name" is set
        if "file_name" not in params or params["file_name"] is None:
            raise ValueError("Missing the required parameter 'file_name' when calling 'get_job_output_file'")
        ...
        return self.api_client.call_api(
            "/v1alpha/job-queue/jobs/{id}/outputs:export", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_jobs(self, *, job_type: "Optional[str]" = None, status: "Optional[str]" = None, name_filter: "Optional[str]" = None, description_filter: "Optional[str]" = None, submitter_name_filter: "Optional[str]" = None, page_size: "Optional[int]" = None, page_number: "Optional[int]" = None) -> "GsaGetJobsResponse":
        """Get a list of jobs.
        ...
        GsaGetJobsResponse
        """
        data = self._get_jobs_with_http_info(job_type, status, name_filter, description_filter, submitter_name_filter, page_size, page_number, _return_http_data_only=True)
        return data  # type: ignore[no-any-return]

    def _get_jobs_with_http_info(self, job_type: "Optional[str]" = None, status: "Optional[str]" = None, name_filter: "Optional[str]" = None, description_filter: "Optional[str]" = None, submitter_name_filter: "Optional[str]" = None, page_size: "Optional[int]" = None, page_number: "Optional[int]" = None, **kwargs: Any) -> Any:
        all_params = ["job_type", "status", "name_filter", "description_filter", "submitter_name_filter", "page_size", "page_number", "_return_http_data_only", "_preload_content", "_request_timeout"]
    ...
    def _get_output_filenames_with_http_info(self, id: "str", **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_output_filenames")
            params[key] = val
        del params["kwargs"]
        # verify the required parameter "id" is set
        if "id" not in params or params["id"] is None:
            raise ValueError("Missing the required parameter 'id' when calling 'get_output_filenames'")
        ...
        return self.api_client.call_api(
            "/v1alpha/job-queue/jobs/{id}/outputs", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _get_processing_config_with_http_info(self, **kwargs: Any) -> Any:
        ...
        for key, val in params["kwargs"].items():
            if key not in all_params:
                raise TypeError(f"Got an unexpected keyword argument '{key}' to method get_processing_config")
            params[key] = val
        del params["kwargs"]
        ...
        return self.api_client.call_api(
            "/v1alpha/job-queue/processing-configuration", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _move_to_top_with_http_info(self, id: "str", **kwargs: Any) -> Any:
        ...
        return self.api_client.call_api(
            "/v1alpha/job-queue/jobs/{id}:move-to-top", "POST",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _restore_job_with_http_info(self, id: "str", **kwargs: Any) -> Any:
        ...
        return self.api_client.call_api(
            "/v1alpha/job-queue/jobs/{id}:retrieve-definition", "GET",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def resubmit(self, *, id: "str", body: "Optional[GsaResubmitJobRequest]" = None) -> "Union[GsaJob, None]":
        """Resubmit a job.
    ...
    def _resubmit_with_http_info(self, id: "str", body: "Optional[GsaResubmitJobRequest]" = None, **kwargs: Any) -> Any:
        all_params = ["id", "body", "_return_http_data_only", "_preload_content", "_request_timeout"]
        ...
        return self.api_client.call_api(
            "/v1alpha/job-queue/jobs/{id}:resubmit", "POST",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def update_job(self, *, id: "str", body: "Optional[GsaUpdateJobRequest]" = None) -> "Union[GsaJob, None]":
        """Update a job.
    ...
    def _update_job_with_http_info(self, id: "str", body: "Optional[GsaUpdateJobRequest]" = None, **kwargs: Any) -> Any:
        all_params = ["id", "body", "_return_http_data_only", "_preload_content", "_request_timeout"]
        ...
        return self.api_client.call_api(
            "/v1alpha/job-queue/jobs/{id}", "PATCH",
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def _upload_file_with_http_info(self, file: "Optional[Union[BinaryIO, pathlib.Path]]" = None, **kwargs: Any) -> Any:
